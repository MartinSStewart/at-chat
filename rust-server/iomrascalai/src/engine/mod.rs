...
use crate::board::NoMove;
use crate::board::Pass;
use crate::board::Resign;
use crate::board::White;
use crate::config::Config;
use crate::game::Game;
use crate::ownership::OwnershipStatistics;
use crate::patterns::SmallPatternMatcher;
use crate::playout::Playout;
use crate::ruleset::KgsChinese;
use crate::score::FinalScore;
...
impl Engine {
    ...
    pub fn new(config: Arc<Config>, small_pattern_matcher: Arc<SmallPatternMatcher>) -> Engine {
        let (send_to_main, receive_from_threads) = unbounded();
    ...
    fn spin_up_worker(&mut self) {
        ...
        let (send_direct_message, receive_direct_message) = unbounded();
