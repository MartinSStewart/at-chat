...
{-| <https://discord.com/developers/docs/resources/channel#get-private-archived-threads>
-}
getPrivateArchivedThreads :
    Authentication
    ->
    ...
    let
        queryParams =
            List.filterMap identity
                [ Maybe.map (\t -> ( "before", Iso8601.fromTime t )) before
