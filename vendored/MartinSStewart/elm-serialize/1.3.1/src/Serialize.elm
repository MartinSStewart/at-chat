...
{-| Codec for serializing an `Int` (when encoding/decoding to Bytes, the range will be restricted to an unsigned int32 )
-}
unsignedInt32 : Codec e Int
unsignedInt32 =
    build
        (BE.unsignedInt32 endian)
        (BD.unsignedInt32 endian |> BD.map Ok)
        JE.int
        (JD.int |> JD.map Ok)
...
{-| Codec for serializing an `Int` (when encoding/decoding to Bytes, the range will be restricted to an unsigned int32 )
-}
unsignedInt16 : Codec e Int
unsignedInt16 =
    build
        (BE.unsignedInt16 endian)
        (BD.unsignedInt16 endian |> BD.map Ok)
        JE.int
        (JD.int |> JD.map Ok)
