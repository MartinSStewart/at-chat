...
deletedMessageContent : Id messageId -> HighlightMessage -> Time.Posix -> Time.Zone -> Element MessageViewMsg
deletedMessageContent messageId highlight createdAt timezone =
    Ui.row
