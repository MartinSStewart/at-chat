...
the left of it and reach down over the messages below. They're simplified from the export, which
recorded a point every few hundredths of a pixel.
-}
...
previewDoodleStroke firstPoint rest =
    { createdBy = previewUserId
