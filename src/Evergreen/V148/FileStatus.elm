module Evergreen.V148.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V148.Coord.Coord Evergreen.V148.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V148.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V148.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V148.FileName.FileName Int ContentType Effect.Http.Error
