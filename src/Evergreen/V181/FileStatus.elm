module Evergreen.V181.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V181.Coord.Coord Evergreen.V181.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V181.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V181.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V181.FileName.FileName Int ContentType Effect.Http.Error
