module Evergreen.V378.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V378.Id.Id Evergreen.V378.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V378.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V378.Id.ThreadRoute Date.Date
