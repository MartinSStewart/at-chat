module Evergreen.V378.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V378.Coord.Coord Evergreen.V378.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V378.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V378.Coord.Coord Evergreen.V378.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V378.Coord.Coord Evergreen.V378.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V378.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V378.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
