module Evergreen.V378.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V378.Id.Id Evergreen.V378.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V378.Id.Id Evergreen.V378.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V378.User.FrontendUser
    , joinedUser : Maybe Evergreen.V378.User.FrontendUser
    }
