module Evergreen.V97.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V97.Id.Id Evergreen.V97.Id.UserId)
    ...
    | AttachedFile (Evergreen.V97.Id.Id Evergreen.V97.FileStatus.FileId)
