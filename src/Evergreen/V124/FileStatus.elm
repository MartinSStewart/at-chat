module Evergreen.V124.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V124.Coord.Coord Evergreen.V124.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V124.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V124.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V124.FileName.FileName Int ContentType Effect.Http.Error
