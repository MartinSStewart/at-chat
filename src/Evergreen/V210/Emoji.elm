module Evergreen.V210.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V210.Id.Id Evergreen.V210.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V210.Id.Id Evergreen.V210.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V210.Id.Id Evergreen.V210.Id.CustomEmojiId)
