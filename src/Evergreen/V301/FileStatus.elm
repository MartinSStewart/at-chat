module Evergreen.V301.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V301.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V301.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V301.FileName.FileName Int ContentType Effect.Http.Error
