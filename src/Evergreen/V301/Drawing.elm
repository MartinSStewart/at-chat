module Evergreen.V301.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V301.Id.Id Evergreen.V301.FileStatus.FileId)
    | EmbedImageAnchor Int


type AnchorType
    = MessageAnchor Evergreen.V301.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V301.Id.ThreadRoute Date.Date
