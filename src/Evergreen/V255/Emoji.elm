module Evergreen.V255.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V255.Id.Id Evergreen.V255.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V255.Id.Id Evergreen.V255.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V255.Id.Id Evergreen.V255.Id.CustomEmojiId)
