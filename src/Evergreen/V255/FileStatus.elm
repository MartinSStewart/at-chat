module Evergreen.V255.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V255.Coord.Coord Evergreen.V255.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V255.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V255.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V255.FileName.FileName Int ContentType Effect.Http.Error
