module Evergreen.V116.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V116.Coord.Coord Evergreen.V116.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V116.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V116.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V116.FileName.FileName Int ContentType Effect.Http.Error
