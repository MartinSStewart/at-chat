module Evergreen.V357.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V357.Id.Id Evergreen.V357.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V357.Id.Id Evergreen.V357.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V357.User.FrontendUser
    , joinedUser : Maybe Evergreen.V357.User.FrontendUser
    }
