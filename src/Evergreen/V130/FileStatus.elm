module Evergreen.V130.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V130.Coord.Coord Evergreen.V130.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V130.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V130.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V130.FileName.FileName Int ContentType Effect.Http.Error
