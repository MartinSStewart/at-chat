module Evergreen.V307.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V307.Id.Id Evergreen.V307.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V307.Id.Id Evergreen.V307.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V307.User.FrontendUser
    , joinedUser : Maybe Evergreen.V307.User.FrontendUser
    }
