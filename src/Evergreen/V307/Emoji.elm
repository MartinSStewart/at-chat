module Evergreen.V307.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V307.Id.Id Evergreen.V307.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V307.Id.Id Evergreen.V307.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V307.Id.Id Evergreen.V307.Id.CustomEmojiId)
