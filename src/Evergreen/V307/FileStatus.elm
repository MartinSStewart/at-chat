module Evergreen.V307.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V307.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V307.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V307.FileName.FileName Int ContentType Effect.Http.Error
