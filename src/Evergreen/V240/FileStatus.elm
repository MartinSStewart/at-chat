module Evergreen.V240.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V240.Coord.Coord Evergreen.V240.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V240.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V240.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V240.FileName.FileName Int ContentType Effect.Http.Error
