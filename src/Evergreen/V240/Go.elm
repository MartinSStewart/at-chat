module Evergreen.V240.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V240.Id.Id Evergreen.V240.Id.UserId
    , whitePlayer : Evergreen.V240.Id.Id Evergreen.V240.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V240.Id.Id Evergreen.V240.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V240.Id.Id Evergreen.V240.Id.ChannelMessageId))
    | PressedReset
