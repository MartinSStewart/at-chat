module Evergreen.V240.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V240.Id.Id Evergreen.V240.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V240.Id.Id Evergreen.V240.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V240.Id.Id Evergreen.V240.Id.CustomEmojiId)
