module Evergreen.V302.WordSpellingGame exposing (..)
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V302.Go.TimeControl
    , traySize : Evergreen.V302.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    , createdBy : Evergreen.V302.Id.Id Evergreen.V302.Id.UserId
    , seed : Int
    , letters : Evergreen.V302.NonemptyDict.NonemptyDict LetterOrWildcard Evergreen.V302.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V302.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
...
type alias Player =
    { userId : Evergreen.V302.Id.Id Evergreen.V302.Id.UserId
    , tray : Evergreen.V302.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
    }
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V302.UserSession.ToBeFilledInByBackend IsValid
    }
