module Evergreen.V302.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V302.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V302.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V302.FileName.FileName Int ContentType Effect.Http.Error
