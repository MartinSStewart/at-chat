module Evergreen.V185.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V185.Coord.Coord Evergreen.V185.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V185.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V185.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V185.FileName.FileName Int ContentType Effect.Http.Error
