module Evergreen.V52.Discord exposing (..)
...
type alias User =
    { id : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.UserId
    , username : String
...
type alias PartialGuild =
    { id : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.GuildId
    , name : String
...
type EmojiType
    ...
    | CustomEmojiType
        { id : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.CustomEmojiId
        , name : Maybe String
        }
...
type alias EmojiData =
    { type_ : EmojiType
    , roles : OptionalData (List (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.RoleId))
...
type alias GuildMember =
    ...
    , roles : List (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.RoleId)
    , joinedAt : Time.Posix
...
type alias Channel =
    { id : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId
    , type_ : ChannelType
    , guildId : OptionalData (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.GuildId)
    , position : OptionalData Int
    , name : OptionalData String
    , topic : OptionalData (Maybe String)
    , nsfw : OptionalData Bool
    , lastMessageId : OptionalData (Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.MessageId))
    ...
    , ownerId : OptionalData (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.UserId)
    , applicationId : OptionalData (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ApplicationId)
    , parentId : OptionalData (Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId))
...
type alias Guild =
    ...
    , ownerId : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.UserId
    , permissions : OptionalData Permissions
    , region : String
    , afkChannelId : Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId)
    , afkTimeout : Quantity.Quantity Int Duration.Seconds
    , embedEnabled : OptionalData Bool
    , embedChannelId : OptionalData (Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId))
    ...
    , mfaLevel : Int
    , applicationId : Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ApplicationId)
    , widgetEnabled : OptionalData Bool
    , widgetChannelId : OptionalData (Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId))
    , systemChannelId : Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId)
    , systemChannelFlags : Int
    , rulesChannelId : Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId)
    ...
    , publicUpdatesChannelId : Maybe (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId)
...
type RoleOrUserId
    = RoleOrUserId_RoleId (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.RoleId)
    | RoleOrUserId_UserId (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.UserId)
...
type alias Attachment =
    { id : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.AttachmentId
    , filename : String
    , size : Int
    , url : String
    , proxyUrl : String
...
type alias Message =
    { id : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.MessageId
    , channelId : Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.ChannelId
    , guildId : OptionalData (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.GuildId)
    , author : User
    , content : String
    ...
    , textToSpeech : Bool
    , mentionEveryone : Bool
    , mentionRoles : List (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.RoleId)
    , attachments : List Attachment
    , reactions : OptionalData (List Reaction)
    , pinned : Bool
    , webhookId : OptionalData (Evergreen.V52.Discord.Id.Id Evergreen.V52.Discord.Id.WebhookId)
    , type_ : MessageType
    , flags : OptionalData Int
