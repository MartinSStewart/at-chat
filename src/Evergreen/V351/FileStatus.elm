module Evergreen.V351.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V351.Coord.Coord Evergreen.V351.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V351.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V351.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V351.FileName.FileName Int ContentType Effect.Http.Error
