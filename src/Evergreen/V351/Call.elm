module Evergreen.V351.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V351.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId (Evergreen.V351.Id.Id Evergreen.V351.Id.UserId)
    | GuildRoomId (Evergreen.V351.Id.Id Evergreen.V351.Id.GuildId) (Evergreen.V351.Id.Id Evergreen.V351.Id.ChannelId)


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V351.Id.Id Evergreen.V351.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V351.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V351.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V351.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V351.NonemptyDict.NonemptyDict ( Evergreen.V351.Id.Id Evergreen.V351.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V351.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V351.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V351.Id.Id Evergreen.V351.Id.UserId, Effect.Lamdera.ClientId ) Float
