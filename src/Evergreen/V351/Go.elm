module Evergreen.V351.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V351.Id.Id Evergreen.V351.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V351.Id.Id Evergreen.V351.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V351.User.FrontendUser
    , joinedUser : Maybe Evergreen.V351.User.FrontendUser
    }
