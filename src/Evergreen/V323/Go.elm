module Evergreen.V323.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V323.Id.Id Evergreen.V323.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V323.Id.Id Evergreen.V323.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V323.User.FrontendUser
    , joinedUser : Maybe Evergreen.V323.User.FrontendUser
    }
