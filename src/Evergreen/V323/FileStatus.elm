module Evergreen.V323.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V323.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V323.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V323.FileName.FileName Int ContentType Effect.Http.Error
