module Evergreen.V323.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V323.Id.Id Evergreen.V323.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V323.Id.Id Evergreen.V323.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V323.Id.Id Evergreen.V323.Id.CustomEmojiId)
