module Evergreen.V147.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V147.Coord.Coord Evergreen.V147.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V147.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V147.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V147.FileName.FileName Int ContentType Effect.Http.Error
