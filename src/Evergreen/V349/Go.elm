module Evergreen.V349.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V349.Id.Id Evergreen.V349.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V349.Id.Id Evergreen.V349.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V349.User.FrontendUser
    , joinedUser : Maybe Evergreen.V349.User.FrontendUser
    }
