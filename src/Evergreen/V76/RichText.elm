module Evergreen.V76.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V76.Id.Id Evergreen.V76.Id.UserId)
    ...
    | AttachedFile (Evergreen.V76.Id.Id Evergreen.V76.FileStatus.FileId)
