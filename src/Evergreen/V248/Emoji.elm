module Evergreen.V248.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V248.Id.Id Evergreen.V248.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V248.Id.Id Evergreen.V248.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V248.Id.Id Evergreen.V248.Id.CustomEmojiId)
