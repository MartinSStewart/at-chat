module Evergreen.V248.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V248.Coord.Coord Evergreen.V248.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V248.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V248.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V248.FileName.FileName Int ContentType Effect.Http.Error
