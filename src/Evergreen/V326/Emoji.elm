module Evergreen.V326.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V326.Id.Id Evergreen.V326.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V326.Id.Id Evergreen.V326.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V326.Id.Id Evergreen.V326.Id.CustomEmojiId)
