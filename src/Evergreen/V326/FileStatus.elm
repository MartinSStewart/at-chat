module Evergreen.V326.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V326.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V326.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V326.FileName.FileName Int ContentType Effect.Http.Error
