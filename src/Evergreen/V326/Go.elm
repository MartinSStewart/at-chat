module Evergreen.V326.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V326.Id.Id Evergreen.V326.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V326.Id.Id Evergreen.V326.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V326.User.FrontendUser
    , joinedUser : Maybe Evergreen.V326.User.FrontendUser
    }
