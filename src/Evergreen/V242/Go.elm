module Evergreen.V242.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V242.Id.Id Evergreen.V242.Id.UserId
    , whitePlayer : Evergreen.V242.Id.Id Evergreen.V242.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V242.Id.Id Evergreen.V242.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V242.Id.Id Evergreen.V242.Id.ChannelMessageId))
    | PressedReset
