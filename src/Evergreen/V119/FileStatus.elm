module Evergreen.V119.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V119.Coord.Coord Evergreen.V119.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V119.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V119.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V119.FileName.FileName Int ContentType Effect.Http.Error
