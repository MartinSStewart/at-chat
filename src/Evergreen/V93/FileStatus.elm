module Evergreen.V93.FileStatus exposing (..)

import Effect.Http
import Evergreen.V93.Coord
import Evergreen.V93.CssPixels
import Evergreen.V93.FileName
...
type alias ImageMetadata =
    { imageSize : Evergreen.V93.Coord.Coord Evergreen.V93.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V93.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V93.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V93.FileName.FileName Int ContentType Effect.Http.Error
