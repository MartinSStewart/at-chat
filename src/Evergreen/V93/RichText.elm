module Evergreen.V93.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V93.Id.Id Evergreen.V93.Id.UserId)
    ...
    | AttachedFile (Evergreen.V93.Id.Id Evergreen.V93.FileStatus.FileId)
