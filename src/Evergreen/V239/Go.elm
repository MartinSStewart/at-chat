module Evergreen.V239.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V239.Id.Id Evergreen.V239.Id.UserId
    , whitePlayer : Evergreen.V239.Id.Id Evergreen.V239.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V239.Id.Id Evergreen.V239.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V239.Id.Id Evergreen.V239.Id.ChannelMessageId))
    | PressedReset
