module Evergreen.V239.FileStatus exposing (..)

import Effect.Http
import Evergreen.V239.Coord
import Evergreen.V239.CssPixels
import Evergreen.V239.FileName
...
type alias ImageMetadata =
    { imageSize : Evergreen.V239.Coord.Coord Evergreen.V239.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V239.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V239.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V239.FileName.FileName Int ContentType Effect.Http.Error
