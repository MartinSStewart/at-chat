module Evergreen.V384.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V384.Id.Id Evergreen.V384.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V384.Id.Id Evergreen.V384.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V384.User.FrontendUser
    , joinedUser : Maybe Evergreen.V384.User.FrontendUser
    }
