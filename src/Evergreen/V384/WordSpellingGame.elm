module Evergreen.V384.WordSpellingGame exposing (..)
...
type alias Player =
    ...
    , tray : Evergreen.V384.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V384.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V384.OneOrGreater.OneOrGreater
    }
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V384.Id.Id Evergreen.V384.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V384.Id.Id Evergreen.V384.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V384.Id.Id Evergreen.V384.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard )) Shared
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V384.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V384.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V384.Go.TimeControl
    , traySize : Evergreen.V384.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V384.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V384.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V384.OneOrGreater.OneOrGreater
    }


type Action
    = PlaceWord PlacedWord (Evergreen.V384.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V384.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V384.Id.Id Evergreen.V384.Id.UserId)
