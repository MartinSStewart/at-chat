module Evergreen.V384.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V384.Id.Id Evergreen.V384.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V384.Id.Id Evergreen.V384.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V384.Id.Id Evergreen.V384.Id.CustomEmojiId)
...
type alias CachedEmojiData =
    ...
    , art : Dict.Dict Char (Array.Array EmojiArt)
    }
