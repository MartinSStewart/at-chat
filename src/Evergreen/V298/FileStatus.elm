module Evergreen.V298.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V298.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V298.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V298.FileName.FileName Int ContentType Effect.Http.Error
