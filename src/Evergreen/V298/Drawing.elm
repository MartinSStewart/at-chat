module Evergreen.V298.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V298.Id.Id Evergreen.V298.FileStatus.FileId)
    | EmbedImageAnchor Int


type AnchorType
    = MessageAnchor Evergreen.V298.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V298.Id.ThreadRoute Date.Date
