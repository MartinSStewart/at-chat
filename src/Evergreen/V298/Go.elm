module Evergreen.V298.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V298.Id.Id Evergreen.V298.Id.UserId
    , whitePlayer : Evergreen.V298.Id.Id Evergreen.V298.Id.UserId
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , blackPlayer : Evergreen.V298.User.FrontendUser
    , whitePlayer : Evergreen.V298.User.FrontendUser
    }
