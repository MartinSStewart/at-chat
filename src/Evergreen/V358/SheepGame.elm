module Evergreen.V358.SheepGame exposing (..)
...
type GameMsg
    ...
    | PressedLockAnswers
    | TypedGroup (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId) Int String
...
type alias Content =
    List.Nonempty.Nonempty (Evergreen.V358.RichText.RichText (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId))
...
type Action
    ...
    | LockedAnswers
    | ChangedGroup (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId) Int String
...
type alias Shared =
    { phase : Phase
    , answers : SeqDict.SeqDict (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId) (Array.Array (Maybe Content))
    , groups : SeqDict.SeqDict ( Evergreen.V358.Id.Id Evergreen.V358.Id.UserId, Int ) String
