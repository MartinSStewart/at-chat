module Evergreen.V358.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V358.User.FrontendUser
    , joinedUser : Maybe Evergreen.V358.User.FrontendUser
    }
