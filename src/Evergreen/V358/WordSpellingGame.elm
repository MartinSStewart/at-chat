module Evergreen.V358.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard ))
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V358.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V358.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V358.Go.TimeControl
    , traySize : Evergreen.V358.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V358.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V358.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V358.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V358.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V358.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias Player =
    { userId : Evergreen.V358.Id.Id Evergreen.V358.Id.UserId
    , tray : Evergreen.V358.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V358.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V358.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V358.Id.Id Evergreen.V358.Id.UserId)
    , highlightedWordCells : Dict.Dict ( Int, Int ) LetterOrWildcard
    , scrollPosition : Evergreen.V358.Scroll.ScrollPosition
