module Evergreen.V252.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V252.Coord.Coord Evergreen.V252.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V252.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V252.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V252.FileName.FileName Int ContentType Effect.Http.Error
