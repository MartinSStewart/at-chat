module Evergreen.V252.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V252.Id.Id Evergreen.V252.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V252.Id.Id Evergreen.V252.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V252.Id.Id Evergreen.V252.Id.CustomEmojiId)
