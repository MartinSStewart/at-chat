module Evergreen.V262.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V262.Id.Id Evergreen.V262.Id.UserId
    , whitePlayer : Evergreen.V262.Id.Id Evergreen.V262.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V262.SecretId.SecretId Evergreen.V262.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V262.User.FrontendUser
    , whitePlayer : Evergreen.V262.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V262.Id.Id Evergreen.V262.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V262.Id.Id Evergreen.V262.Id.ChannelMessageId) (Evergreen.V262.UserSession.ToBeFilledInByBackend (Evergreen.V262.SecretId.SecretId Evergreen.V262.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V262.Id.Id Evergreen.V262.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V262.Id.Id Evergreen.V262.Id.ChannelMessageId)
