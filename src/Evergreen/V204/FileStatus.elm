module Evergreen.V204.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V204.Coord.Coord Evergreen.V204.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V204.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V204.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V204.FileName.FileName Int ContentType Effect.Http.Error
