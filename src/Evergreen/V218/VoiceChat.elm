module Evergreen.V218.VoiceChat exposing (..)

import Bytes
import Effect.Lamdera
import Effect.Time
import Evergreen.V218.Id
import Evergreen.V218.IdString
...
type RoomId
    = DmRoomId (Evergreen.V218.Id.Id Evergreen.V218.Id.UserId)


type alias ConnectionId =
    { roomId : RoomId
    , otherClientId : ( Evergreen.V218.Id.Id Evergreen.V218.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict RoomId (Evergreen.V218.NonemptySet.NonemptySet ( Evergreen.V218.Id.Id Evergreen.V218.Id.UserId, Effect.Lamdera.ClientId ))
    }
...
type alias MediaDevice =
    { deviceId : Evergreen.V218.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V218.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V218.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V218.Id.Id Evergreen.V218.Id.UserId, Effect.Lamdera.ClientId ) Float
...
type FromJs
    ...
    | FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V218.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V218.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V218.IdString.IdString MediaDeviceId)
    | PressedToggleMute
