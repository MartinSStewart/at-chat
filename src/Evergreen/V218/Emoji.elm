module Evergreen.V218.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V218.Id.Id Evergreen.V218.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V218.Id.Id Evergreen.V218.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V218.Id.Id Evergreen.V218.Id.CustomEmojiId)
