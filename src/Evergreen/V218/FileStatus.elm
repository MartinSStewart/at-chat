module Evergreen.V218.FileStatus exposing (..)

import Effect.Http
import Evergreen.V218.Coord
import Evergreen.V218.CssPixels
import Evergreen.V218.FileName
...
type alias ImageMetadata =
    { imageSize : Evergreen.V218.Coord.Coord Evergreen.V218.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V218.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V218.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V218.FileName.FileName Int ContentType Effect.Http.Error
