module Evergreen.V218.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V218.Id.Id Evergreen.V218.Id.UserId
    , whitePlayer : Evergreen.V218.Id.Id Evergreen.V218.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V218.Id.Id Evergreen.V218.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V218.Id.Id Evergreen.V218.Id.ChannelMessageId))
    | PressedReset
