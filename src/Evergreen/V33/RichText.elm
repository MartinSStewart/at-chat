module Evergreen.V33.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V33.Id.Id Evergreen.V33.Id.UserId)
    ...
    | AttachedFile (Evergreen.V33.Id.Id Evergreen.V33.FileStatus.FileId)
