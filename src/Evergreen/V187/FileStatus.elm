module Evergreen.V187.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V187.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V187.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V187.FileName.FileName Int ContentType Effect.Http.Error
