module Evergreen.V149.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V149.Coord.Coord Evergreen.V149.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V149.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V149.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V149.FileName.FileName Int ContentType Effect.Http.Error
