module Evergreen.V144.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V144.Coord.Coord Evergreen.V144.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V144.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V144.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V144.FileName.FileName Int ContentType Effect.Http.Error
