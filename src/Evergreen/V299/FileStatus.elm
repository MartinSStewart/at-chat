module Evergreen.V299.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V299.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V299.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V299.FileName.FileName Int ContentType Effect.Http.Error
