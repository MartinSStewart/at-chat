module Evergreen.V299.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V299.Id.Id Evergreen.V299.FileStatus.FileId)
    | EmbedImageAnchor Int


type AnchorType
    = MessageAnchor Evergreen.V299.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V299.Id.ThreadRoute Date.Date
