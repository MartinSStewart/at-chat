module Evergreen.V343.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V343.Id.Id Evergreen.V343.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V343.Id.Id Evergreen.V343.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V343.User.FrontendUser
    , joinedUser : Maybe Evergreen.V343.User.FrontendUser
    }
