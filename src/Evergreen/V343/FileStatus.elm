module Evergreen.V343.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V343.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V343.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V343.FileName.FileName Int ContentType Effect.Http.Error
