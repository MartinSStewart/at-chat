module Evergreen.V382.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V382.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V382.Id.Viewing_DmId
    | GuildRoomId Evergreen.V382.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V382.Id.Id Evergreen.V382.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V382.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V382.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V382.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V382.NonemptyDict.NonemptyDict ( Evergreen.V382.Id.Id Evergreen.V382.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V382.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V382.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V382.Id.Id Evergreen.V382.Id.UserId, Effect.Lamdera.ClientId ) Float
