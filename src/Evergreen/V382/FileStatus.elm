module Evergreen.V382.FileStatus exposing (..)
...
type alias Location =
    { lat : Evergreen.V382.SafeFloat.SafeFloat
    , lon : Evergreen.V382.SafeFloat.SafeFloat
    }
...
type alias ImageMetadata =
    ...
    , fNumber : Maybe Evergreen.V382.SafeFloat.SafeFloat
    , focalLength : Maybe Evergreen.V382.SafeFloat.SafeFloat
...
type alias VideoMetadata =
    { videoSize : Evergreen.V382.Coord.Coord Evergreen.V382.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V382.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V382.Coord.Coord Evergreen.V382.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V382.Coord.Coord Evergreen.V382.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V382.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V382.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
