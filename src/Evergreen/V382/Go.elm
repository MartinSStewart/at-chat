module Evergreen.V382.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V382.Id.Id Evergreen.V382.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V382.Id.Id Evergreen.V382.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V382.User.FrontendUser
    , joinedUser : Maybe Evergreen.V382.User.FrontendUser
    }
