module Evergreen.V382.WordSpellingGame exposing (..)
...
type alias Player =
    ...
    , tray : Evergreen.V382.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V382.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V382.OneOrGreater.OneOrGreater
    }
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V382.Id.Id Evergreen.V382.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V382.Id.Id Evergreen.V382.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V382.Id.Id Evergreen.V382.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard )) Shared
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V382.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V382.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V382.Go.TimeControl
    , traySize : Evergreen.V382.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V382.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V382.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V382.OneOrGreater.OneOrGreater
    }


type Action
    = PlaceWord PlacedWord (Evergreen.V382.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V382.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V382.Id.Id Evergreen.V382.Id.UserId)
