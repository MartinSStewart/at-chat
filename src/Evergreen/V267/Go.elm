module Evergreen.V267.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V267.Id.Id Evergreen.V267.Id.UserId
    , whitePlayer : Evergreen.V267.Id.Id Evergreen.V267.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V267.SecretId.SecretId Evergreen.V267.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V267.User.FrontendUser
    , whitePlayer : Evergreen.V267.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V267.Id.Id Evergreen.V267.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V267.Id.Id Evergreen.V267.Id.ChannelMessageId) (Evergreen.V267.UserSession.ToBeFilledInByBackend (Evergreen.V267.SecretId.SecretId Evergreen.V267.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V267.Id.Id Evergreen.V267.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V267.Id.Id Evergreen.V267.Id.ChannelMessageId)
