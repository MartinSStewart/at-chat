module Evergreen.V267.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V267.Id.Id Evergreen.V267.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V267.Id.Id Evergreen.V267.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V267.Id.Id Evergreen.V267.Id.CustomEmojiId)
