module Evergreen.V304.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V304.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V304.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V304.FileName.FileName Int ContentType Effect.Http.Error
