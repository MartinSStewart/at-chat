module Evergreen.V304.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V304.Id.Id Evergreen.V304.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V304.Id.Id Evergreen.V304.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V304.User.FrontendUser
    , joinedUser : Maybe Evergreen.V304.User.FrontendUser
    }
