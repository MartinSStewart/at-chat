module Evergreen.V304.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V304.Id.Id Evergreen.V304.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V304.Id.Id Evergreen.V304.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V304.Id.Id Evergreen.V304.Id.CustomEmojiId)
