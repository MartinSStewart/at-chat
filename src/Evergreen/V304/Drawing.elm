module Evergreen.V304.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V304.Id.Id Evergreen.V304.FileStatus.FileId)
    | EmbedImageAnchor Int


type AnchorType
    = MessageAnchor Evergreen.V304.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V304.Id.ThreadRoute Date.Date
