module Evergreen.V192.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V192.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V192.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V192.FileName.FileName Int ContentType Effect.Http.Error
