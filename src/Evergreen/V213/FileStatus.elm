module Evergreen.V213.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V213.Coord.Coord Evergreen.V213.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V213.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V213.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V213.FileName.FileName Int ContentType Effect.Http.Error
