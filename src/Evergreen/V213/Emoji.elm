module Evergreen.V213.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V213.Id.Id Evergreen.V213.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V213.Id.Id Evergreen.V213.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V213.Id.Id Evergreen.V213.Id.CustomEmojiId)
