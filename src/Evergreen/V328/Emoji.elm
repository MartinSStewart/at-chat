module Evergreen.V328.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V328.Id.Id Evergreen.V328.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V328.Id.Id Evergreen.V328.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V328.Id.Id Evergreen.V328.Id.CustomEmojiId)
