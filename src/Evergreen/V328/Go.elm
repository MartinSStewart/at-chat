module Evergreen.V328.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V328.Id.Id Evergreen.V328.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V328.Id.Id Evergreen.V328.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V328.User.FrontendUser
    , joinedUser : Maybe Evergreen.V328.User.FrontendUser
    }
