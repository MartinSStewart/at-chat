module Evergreen.V328.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V328.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V328.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V328.FileName.FileName Int ContentType Effect.Http.Error
