module Evergreen.V160.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V160.Coord.Coord Evergreen.V160.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V160.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V160.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V160.FileName.FileName Int ContentType Effect.Http.Error
