module Evergreen.V112.Discord exposing (..)

import Duration
import Evergreen.V112.Discord.Id
import Evergreen.V112.SafeJson
import Quantity
import Time
...
type alias PartialUser =
    { id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.UserId
    , username : String
...
type alias UserAuth =
    { token : String
    , userAgent : String
    , xSuperProperties : Evergreen.V112.SafeJson.SafeJson
    }
...
type alias Attachment =
    { id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.AttachmentId
    , filename : String
    , size : Int
    , url : String
    , proxyUrl : String
...
type EmojiType
    ...
    | CustomEmojiType
        { id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.CustomEmojiId
        , name : Maybe String
        }
...
type alias EmojiData =
    { type_ : EmojiType
    , roles : OptionalData (List (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.RoleId))
...
type alias Message =
    { id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.MessageId
    , channelId : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ChannelId
    , guildId : OptionalData (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.GuildId)
    , author : User
    , content : String
    ...
    , mentionRoles : List (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.RoleId)
    , attachments : List Attachment
    , reactions : OptionalData (List Reaction)
    , pinned : Bool
    , webhookId : OptionalData (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.WebhookId)
    , type_ : MessageType
    , flags : OptionalData Int
...
type alias Channel =
    { id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ChannelId
    , type_ : ChannelType
    , guildId : OptionalData (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.GuildId)
    ...
    , lastMessageId : OptionalData (Maybe (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.MessageId))
    ...
    , ownerId : OptionalData (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.UserId)
    , applicationId : OptionalData (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ApplicationId)
    , parentId : OptionalData (Maybe (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ChannelId))
...
type alias GatewayGuildProperties =
    ...
    , id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.GuildId
    , systemChannelId : Maybe (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ChannelId)
    , afkChannelId : Maybe (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ChannelId)
    , name : String
    , maxMembers : Maybe Int
    , nsfw : Bool
    , description : Maybe String
    , preferredLocale : String
    , rulesChannelId : Maybe (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.ChannelId)
    , ownerId : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.UserId
    }
...
type alias Sticker =
    { id : Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.StickerId
    , packId : OptionalData (Evergreen.V112.Discord.Id.Id Evergreen.V112.Discord.Id.StickerPackId)
    , name : String
    , description : Maybe String
    , tags : String
