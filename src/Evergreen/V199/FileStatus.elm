module Evergreen.V199.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V199.Coord.Coord Evergreen.V199.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V199.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V199.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V199.FileName.FileName Int ContentType Effect.Http.Error
