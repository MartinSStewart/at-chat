module Evergreen.V381.Call exposing (..)

import Bytes
import Effect.Lamdera
import Effect.Time
import Evergreen.V381.Id
import Evergreen.V381.IdString
...
type alias MediaDevice =
    { deviceId : Evergreen.V381.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V381.Id.Viewing_DmId
    | GuildRoomId Evergreen.V381.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V381.Id.Id Evergreen.V381.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V381.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V381.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V381.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V381.NonemptyDict.NonemptyDict ( Evergreen.V381.Id.Id Evergreen.V381.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V381.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V381.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V381.Id.Id Evergreen.V381.Id.UserId, Effect.Lamdera.ClientId ) Float
