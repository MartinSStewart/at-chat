module Evergreen.V381.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V381.Id.Id Evergreen.V381.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V381.Id.Id Evergreen.V381.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V381.User.FrontendUser
    , joinedUser : Maybe Evergreen.V381.User.FrontendUser
    }
