module Evergreen.V228.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V228.Id.Id Evergreen.V228.Id.UserId
    , whitePlayer : Evergreen.V228.Id.Id Evergreen.V228.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V228.Id.Id Evergreen.V228.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V228.Id.Id Evergreen.V228.Id.ChannelMessageId))
    | PressedReset
