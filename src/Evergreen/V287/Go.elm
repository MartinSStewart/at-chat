module Evergreen.V287.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V287.Id.Id Evergreen.V287.Id.UserId
    , whitePlayer : Evergreen.V287.Id.Id Evergreen.V287.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V287.SecretId.SecretId Evergreen.V287.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V287.User.FrontendUser
    , whitePlayer : Evergreen.V287.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V287.Id.Id Evergreen.V287.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V287.Id.Id Evergreen.V287.Id.ChannelMessageId) (Evergreen.V287.UserSession.ToBeFilledInByBackend (Evergreen.V287.SecretId.SecretId Evergreen.V287.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V287.Id.Id Evergreen.V287.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V287.Id.Id Evergreen.V287.Id.ChannelMessageId)
