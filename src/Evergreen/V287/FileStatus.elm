module Evergreen.V287.FileStatus exposing (..)

import Effect.Http
import Evergreen.V287.Coord
import Evergreen.V287.CssPixels
import Evergreen.V287.FileName
...
type alias FileData =
    { fileName : Evergreen.V287.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V287.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V287.FileName.FileName Int ContentType Effect.Http.Error
