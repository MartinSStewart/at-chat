module Evergreen.V41.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V41.Id.Id Evergreen.V41.Id.UserId)
    ...
    | AttachedFile (Evergreen.V41.Id.Id Evergreen.V41.FileStatus.FileId)
