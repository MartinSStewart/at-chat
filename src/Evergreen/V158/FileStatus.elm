module Evergreen.V158.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V158.Coord.Coord Evergreen.V158.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V158.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V158.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V158.FileName.FileName Int ContentType Effect.Http.Error
