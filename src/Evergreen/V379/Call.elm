module Evergreen.V379.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V379.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V379.Id.Viewing_DmId
    | GuildRoomId Evergreen.V379.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V379.Id.Id Evergreen.V379.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V379.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V379.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V379.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V379.NonemptyDict.NonemptyDict ( Evergreen.V379.Id.Id Evergreen.V379.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V379.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V379.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V379.Id.Id Evergreen.V379.Id.UserId, Effect.Lamdera.ClientId ) Float
