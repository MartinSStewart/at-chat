module Evergreen.V379.WordSpellingGame exposing (..)
...
type alias Player =
    ...
    , tray : Evergreen.V379.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V379.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V379.OneOrGreater.OneOrGreater
    }
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V379.Id.Id Evergreen.V379.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V379.Id.Id Evergreen.V379.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V379.Id.Id Evergreen.V379.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard )) Shared
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V379.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V379.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V379.Go.TimeControl
    , traySize : Evergreen.V379.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V379.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V379.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V379.OneOrGreater.OneOrGreater
    }


type Action
    = PlaceWord PlacedWord (Evergreen.V379.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V379.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V379.Id.Id Evergreen.V379.Id.UserId)
