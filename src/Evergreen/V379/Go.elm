module Evergreen.V379.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V379.Id.Id Evergreen.V379.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V379.Id.Id Evergreen.V379.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V379.User.FrontendUser
    , joinedUser : Maybe Evergreen.V379.User.FrontendUser
    }
