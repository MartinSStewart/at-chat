module Evergreen.V56.TwoFactorAuthentication exposing (..)
...
type alias TwoFactorSetupData =
    { qrCodeUrl : String
    , code : String
    , attempts : SeqDict.SeqDict Int Evergreen.V56.LoginForm.CodeStatus
    }
...
type alias TwoFactorAuthentication =
    { secret : Evergreen.V56.SecretId.SecretId TwoFactorSecret
