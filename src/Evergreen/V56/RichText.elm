module Evergreen.V56.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V56.Id.Id Evergreen.V56.Id.UserId)
    ...
    | AttachedFile (Evergreen.V56.Id.Id Evergreen.V56.FileStatus.FileId)
