module Evergreen.V39.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V39.Id.Id Evergreen.V39.Id.UserId)
    ...
    | AttachedFile (Evergreen.V39.Id.Id Evergreen.V39.FileStatus.FileId)
