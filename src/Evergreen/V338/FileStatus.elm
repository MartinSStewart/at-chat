module Evergreen.V338.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V338.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V338.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V338.FileName.FileName Int ContentType Effect.Http.Error
