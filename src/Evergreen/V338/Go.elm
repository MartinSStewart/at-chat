module Evergreen.V338.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V338.Id.Id Evergreen.V338.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V338.Id.Id Evergreen.V338.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V338.User.FrontendUser
    , joinedUser : Maybe Evergreen.V338.User.FrontendUser
    }
