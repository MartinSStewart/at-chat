module Evergreen.V263.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V263.Id.Id Evergreen.V263.Id.UserId
    , whitePlayer : Evergreen.V263.Id.Id Evergreen.V263.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V263.SecretId.SecretId Evergreen.V263.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V263.User.FrontendUser
    , whitePlayer : Evergreen.V263.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V263.Id.Id Evergreen.V263.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V263.Id.Id Evergreen.V263.Id.ChannelMessageId) (Evergreen.V263.UserSession.ToBeFilledInByBackend (Evergreen.V263.SecretId.SecretId Evergreen.V263.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V263.Id.Id Evergreen.V263.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V263.Id.Id Evergreen.V263.Id.ChannelMessageId)
