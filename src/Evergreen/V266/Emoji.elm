module Evergreen.V266.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V266.Id.Id Evergreen.V266.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V266.Id.Id Evergreen.V266.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V266.Id.Id Evergreen.V266.Id.CustomEmojiId)
