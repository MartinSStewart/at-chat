module Evergreen.V266.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V266.Coord.Coord Evergreen.V266.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V266.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V266.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V266.FileName.FileName Int ContentType Effect.Http.Error
