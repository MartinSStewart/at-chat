module Evergreen.V215.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V215.Coord.Coord Evergreen.V215.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V215.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V215.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V215.FileName.FileName Int ContentType Effect.Http.Error
