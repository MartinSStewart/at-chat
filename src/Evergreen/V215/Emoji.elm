module Evergreen.V215.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V215.Id.Id Evergreen.V215.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V215.Id.Id Evergreen.V215.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V215.Id.Id Evergreen.V215.Id.CustomEmojiId)
