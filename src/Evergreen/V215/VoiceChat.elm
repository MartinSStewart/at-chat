module Evergreen.V215.VoiceChat exposing (..)
...
type RoomId
    = DmRoomId (Evergreen.V215.Id.Id Evergreen.V215.Id.UserId)


type alias ConnectionId =
    { roomId : RoomId
    , otherClientId : ( Evergreen.V215.Id.Id Evergreen.V215.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict RoomId (Evergreen.V215.NonemptySet.NonemptySet ( Evergreen.V215.Id.Id Evergreen.V215.Id.UserId, Effect.Lamdera.ClientId ))
    }
...
type alias MediaDevice =
    { deviceId : Evergreen.V215.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V215.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V215.IdString.IdString MediaDeviceId)
    ...
    , expanded : SeqSet.SeqSet RoomId
    , localIsSpeaking : Bool
    , startConnectionError : Maybe String
    , volume : SeqDict.SeqDict ( Evergreen.V215.Id.Id Evergreen.V215.Id.UserId, Effect.Lamdera.ClientId ) Float
...
type FromJs
    ...
    | FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V215.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V215.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V215.IdString.IdString MediaDeviceId)
    | PressedToggleMute
