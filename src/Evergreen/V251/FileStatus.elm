module Evergreen.V251.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V251.Coord.Coord Evergreen.V251.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V251.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V251.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V251.FileName.FileName Int ContentType Effect.Http.Error
