module Evergreen.V333.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V333.Id.Id Evergreen.V333.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V333.Id.Id Evergreen.V333.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V333.User.FrontendUser
    , joinedUser : Maybe Evergreen.V333.User.FrontendUser
    }
