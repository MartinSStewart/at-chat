module Evergreen.V261.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V261.Coord.Coord Evergreen.V261.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V261.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V261.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V261.FileName.FileName Int ContentType Effect.Http.Error
