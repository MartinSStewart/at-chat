module Evergreen.V366.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V366.Id.Id Evergreen.V366.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V366.Id.Id Evergreen.V366.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V366.User.FrontendUser
    , joinedUser : Maybe Evergreen.V366.User.FrontendUser
    }
