module Evergreen.V366.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V366.Coord.Coord Evergreen.V366.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V366.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V366.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V366.FileName.FileName Int ContentType Effect.Http.Error
