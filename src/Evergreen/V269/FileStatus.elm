module Evergreen.V269.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V269.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V269.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V269.FileName.FileName Int ContentType Effect.Http.Error
