module Evergreen.V269.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V269.Id.Id Evergreen.V269.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V269.Id.Id Evergreen.V269.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V269.Id.Id Evergreen.V269.Id.CustomEmojiId)
