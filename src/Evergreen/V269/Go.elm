module Evergreen.V269.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V269.Id.Id Evergreen.V269.Id.UserId
    , whitePlayer : Evergreen.V269.Id.Id Evergreen.V269.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V269.SecretId.SecretId Evergreen.V269.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V269.User.FrontendUser
    , whitePlayer : Evergreen.V269.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V269.Id.Id Evergreen.V269.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V269.Id.Id Evergreen.V269.Id.ChannelMessageId) (Evergreen.V269.UserSession.ToBeFilledInByBackend (Evergreen.V269.SecretId.SecretId Evergreen.V269.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V269.Id.Id Evergreen.V269.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V269.Id.Id Evergreen.V269.Id.ChannelMessageId)
