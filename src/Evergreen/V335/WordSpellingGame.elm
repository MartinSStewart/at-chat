module Evergreen.V335.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V335.Id.Id Evergreen.V335.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V335.Id.Id Evergreen.V335.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V335.Id.Id Evergreen.V335.Id.UserId)
    | UserScrolledPastMoves Evergreen.V335.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V335.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V335.Go.TimeControl
    , traySize : Evergreen.V335.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V335.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V335.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V335.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V335.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V335.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias Player =
    { userId : Evergreen.V335.Id.Id Evergreen.V335.Id.UserId
    , tray : Evergreen.V335.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V335.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V335.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V335.Id.Id Evergreen.V335.Id.UserId)
    , scrollPosition : Evergreen.V335.Scroll.ScrollPosition
