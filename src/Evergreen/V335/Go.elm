module Evergreen.V335.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V335.Id.Id Evergreen.V335.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V335.Id.Id Evergreen.V335.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V335.User.FrontendUser
    , joinedUser : Maybe Evergreen.V335.User.FrontendUser
    }
