module Evergreen.V229.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V229.Id.Id Evergreen.V229.Id.UserId
    , whitePlayer : Evergreen.V229.Id.Id Evergreen.V229.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V229.Id.Id Evergreen.V229.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V229.Id.Id Evergreen.V229.Id.ChannelMessageId))
    | PressedReset
