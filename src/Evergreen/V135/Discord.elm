module Evergreen.V135.Discord exposing (..)
...
type alias UserAuth =
    { token : String
    , userAgent : String
    , xSuperProperties : Evergreen.V135.SafeJson.SafeJson
    }
...
type alias PartialUser =
    { id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.UserId
    , username : String
...
type alias Attachment =
    { id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.AttachmentId
    , filename : String
    , size : Int
    , url : String
    , proxyUrl : String
...
type EmojiType
    ...
    | CustomEmojiType
        { id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.CustomEmojiId
        , name : Maybe String
        }
...
type alias EmojiData =
    { type_ : EmojiType
    , roles : OptionalData (List (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.RoleId))
...
type alias Message =
    { id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.MessageId
    , channelId : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ChannelId
    , guildId : OptionalData (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.GuildId)
    , author : User
    , content : String
    ...
    , mentionRoles : List (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.RoleId)
    , attachments : List Attachment
    , reactions : OptionalData (List Reaction)
    , pinned : Bool
    , webhookId : OptionalData (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.WebhookId)
    , type_ : MessageType
    , flags : OptionalData Int
...
type alias Channel =
    { id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ChannelId
    , type_ : ChannelType
    , guildId : OptionalData (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.GuildId)
    ...
    , lastMessageId : OptionalData (Maybe (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.MessageId))
    ...
    , ownerId : OptionalData (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.UserId)
    , applicationId : OptionalData (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ApplicationId)
    , parentId : OptionalData (Maybe (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ChannelId))
...
type alias GatewayGuildProperties =
    ...
    , id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.GuildId
    , systemChannelId : Maybe (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ChannelId)
    , afkChannelId : Maybe (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ChannelId)
    , name : String
    , maxMembers : Maybe Int
    , nsfw : Bool
    , description : Maybe String
    , preferredLocale : String
    , rulesChannelId : Maybe (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.ChannelId)
    , ownerId : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.UserId
    }
...
type alias Sticker =
    { id : Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.StickerId
    , packId : OptionalData (Evergreen.V135.Discord.Id.Id Evergreen.V135.Discord.Id.StickerPackId)
    , name : String
    , description : Maybe String
    , tags : String
