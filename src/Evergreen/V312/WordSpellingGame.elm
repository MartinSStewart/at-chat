module Evergreen.V312.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V312.Id.Id Evergreen.V312.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V312.Id.Id Evergreen.V312.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V312.Id.Id Evergreen.V312.Id.UserId)
    | UserScrolledPastMoves Evergreen.V312.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V312.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V312.Go.TimeControl
    , traySize : Evergreen.V312.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V312.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V312.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V312.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V312.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
...
type alias Player =
    { userId : Evergreen.V312.Id.Id Evergreen.V312.Id.UserId
    , tray : Evergreen.V312.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
    }
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V312.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V312.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V312.Id.Id Evergreen.V312.Id.UserId)
    , scrollPosition : Evergreen.V312.Scroll.ScrollPosition
    }
