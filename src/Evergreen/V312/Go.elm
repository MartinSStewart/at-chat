module Evergreen.V312.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V312.Id.Id Evergreen.V312.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V312.Id.Id Evergreen.V312.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V312.User.FrontendUser
    , joinedUser : Maybe Evergreen.V312.User.FrontendUser
    }
