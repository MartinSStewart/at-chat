module Evergreen.V312.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V312.Id.Id Evergreen.V312.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V312.Id.Id Evergreen.V312.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V312.Id.Id Evergreen.V312.Id.CustomEmojiId)
