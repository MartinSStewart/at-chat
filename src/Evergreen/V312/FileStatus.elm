module Evergreen.V312.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V312.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V312.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V312.FileName.FileName Int ContentType Effect.Http.Error
