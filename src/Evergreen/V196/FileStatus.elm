module Evergreen.V196.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V196.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V196.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V196.FileName.FileName Int ContentType Effect.Http.Error
