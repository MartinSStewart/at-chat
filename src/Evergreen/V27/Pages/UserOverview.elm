module Evergreen.V27.Pages.UserOverview exposing (..)
...
type alias TwoFactorSetupData =
    { qrCodeUrl : String
    , code : String
    , attempts : SeqDict.SeqDict Int Evergreen.V27.LoginForm.CodeStatus
    }
...
type Msg
    = SelectedNotificationFrequency Evergreen.V27.User.EmailNotifications
