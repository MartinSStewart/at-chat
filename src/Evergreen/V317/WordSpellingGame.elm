module Evergreen.V317.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V317.Id.Id Evergreen.V317.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V317.Id.Id Evergreen.V317.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V317.Id.Id Evergreen.V317.Id.UserId)
    | UserScrolledPastMoves Evergreen.V317.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V317.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V317.Go.TimeControl
    , traySize : Evergreen.V317.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V317.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V317.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V317.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V317.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
...
type alias Player =
    { userId : Evergreen.V317.Id.Id Evergreen.V317.Id.UserId
    , tray : Evergreen.V317.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
    }
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V317.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V317.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V317.Id.Id Evergreen.V317.Id.UserId)
    , scrollPosition : Evergreen.V317.Scroll.ScrollPosition
    }
