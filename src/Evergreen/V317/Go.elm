module Evergreen.V317.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V317.Id.Id Evergreen.V317.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V317.Id.Id Evergreen.V317.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V317.User.FrontendUser
    , joinedUser : Maybe Evergreen.V317.User.FrontendUser
    }
