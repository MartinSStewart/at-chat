module Evergreen.V317.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V317.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V317.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V317.FileName.FileName Int ContentType Effect.Http.Error
