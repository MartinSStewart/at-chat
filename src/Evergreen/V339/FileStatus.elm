module Evergreen.V339.FileStatus exposing (..)

import Effect.Http
import Evergreen.V339.Coord
import Evergreen.V339.CssPixels
import Evergreen.V339.FileName
...
type alias FileData =
    { fileName : Evergreen.V339.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V339.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V339.FileName.FileName Int ContentType Effect.Http.Error
