module Evergreen.V339.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V339.Id.Id Evergreen.V339.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V339.Id.Id Evergreen.V339.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V339.User.FrontendUser
    , joinedUser : Maybe Evergreen.V339.User.FrontendUser
    }
