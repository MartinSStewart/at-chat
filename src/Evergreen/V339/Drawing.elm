module Evergreen.V339.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V339.Id.Id Evergreen.V339.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V339.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V339.Id.ThreadRoute Date.Date
