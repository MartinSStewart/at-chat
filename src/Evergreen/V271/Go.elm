module Evergreen.V271.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V271.Id.Id Evergreen.V271.Id.UserId
    , whitePlayer : Evergreen.V271.Id.Id Evergreen.V271.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V271.SecretId.SecretId Evergreen.V271.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V271.User.FrontendUser
    , whitePlayer : Evergreen.V271.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V271.Id.Id Evergreen.V271.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V271.Id.Id Evergreen.V271.Id.ChannelMessageId) (Evergreen.V271.UserSession.ToBeFilledInByBackend (Evergreen.V271.SecretId.SecretId Evergreen.V271.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V271.Id.Id Evergreen.V271.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V271.Id.Id Evergreen.V271.Id.ChannelMessageId)
