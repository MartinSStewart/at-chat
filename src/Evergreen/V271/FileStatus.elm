module Evergreen.V271.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V271.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V271.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V271.FileName.FileName Int ContentType Effect.Http.Error
