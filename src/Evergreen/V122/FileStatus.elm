module Evergreen.V122.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V122.Coord.Coord Evergreen.V122.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V122.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V122.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V122.FileName.FileName Int ContentType Effect.Http.Error
