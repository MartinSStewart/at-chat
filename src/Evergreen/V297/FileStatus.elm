module Evergreen.V297.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V297.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V297.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V297.FileName.FileName Int ContentType Effect.Http.Error
