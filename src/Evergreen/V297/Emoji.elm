module Evergreen.V297.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V297.Id.Id Evergreen.V297.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V297.Id.Id Evergreen.V297.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V297.Id.Id Evergreen.V297.Id.CustomEmojiId)
