module Evergreen.V194.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V194.Coord.Coord Evergreen.V194.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V194.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V194.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V194.FileName.FileName Int ContentType Effect.Http.Error
