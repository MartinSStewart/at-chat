module Evergreen.V290.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V290.Id.Id Evergreen.V290.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V290.Id.Id Evergreen.V290.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V290.Id.Id Evergreen.V290.Id.CustomEmojiId)
