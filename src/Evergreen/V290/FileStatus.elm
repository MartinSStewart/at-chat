module Evergreen.V290.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V290.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V290.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V290.FileName.FileName Int ContentType Effect.Http.Error
