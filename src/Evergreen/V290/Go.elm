module Evergreen.V290.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V290.Id.Id Evergreen.V290.Id.UserId
    , whitePlayer : Evergreen.V290.Id.Id Evergreen.V290.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V290.SecretId.SecretId Evergreen.V290.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V290.User.FrontendUser
    , whitePlayer : Evergreen.V290.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V290.Id.Id Evergreen.V290.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V290.Id.Id Evergreen.V290.Id.ChannelMessageId) (Evergreen.V290.UserSession.ToBeFilledInByBackend (Evergreen.V290.SecretId.SecretId Evergreen.V290.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V290.Id.Id Evergreen.V290.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V290.Id.Id Evergreen.V290.Id.ChannelMessageId)
