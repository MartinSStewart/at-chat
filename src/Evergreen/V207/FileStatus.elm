module Evergreen.V207.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V207.Coord.Coord Evergreen.V207.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V207.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V207.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V207.FileName.FileName Int ContentType Effect.Http.Error
