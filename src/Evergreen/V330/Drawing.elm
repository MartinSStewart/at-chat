module Evergreen.V330.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V330.Id.Id Evergreen.V330.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V330.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V330.Id.ThreadRoute Date.Date
