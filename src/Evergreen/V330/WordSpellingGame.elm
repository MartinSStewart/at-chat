module Evergreen.V330.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V330.Id.Id Evergreen.V330.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V330.Id.Id Evergreen.V330.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V330.Id.Id Evergreen.V330.Id.UserId)
    | UserScrolledPastMoves Evergreen.V330.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V330.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V330.Go.TimeControl
    , traySize : Evergreen.V330.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V330.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V330.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V330.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V330.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V330.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias Player =
    { userId : Evergreen.V330.Id.Id Evergreen.V330.Id.UserId
    , tray : Evergreen.V330.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V330.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V330.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V330.Id.Id Evergreen.V330.Id.UserId)
    , scrollPosition : Evergreen.V330.Scroll.ScrollPosition
