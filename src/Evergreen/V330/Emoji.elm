module Evergreen.V330.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V330.Id.Id Evergreen.V330.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V330.Id.Id Evergreen.V330.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V330.Id.Id Evergreen.V330.Id.CustomEmojiId)
