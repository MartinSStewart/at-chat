module Evergreen.V330.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V330.Id.Id Evergreen.V330.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V330.Id.Id Evergreen.V330.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V330.User.FrontendUser
    , joinedUser : Maybe Evergreen.V330.User.FrontendUser
    }
