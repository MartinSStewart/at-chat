module Evergreen.V275.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V275.Coord.Coord Evergreen.V275.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V275.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V275.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V275.FileName.FileName Int ContentType Effect.Http.Error
