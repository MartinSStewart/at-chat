module Evergreen.V179.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V179.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V179.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V179.FileName.FileName Int ContentType Effect.Http.Error
