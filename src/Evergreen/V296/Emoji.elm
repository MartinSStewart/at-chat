module Evergreen.V296.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V296.Id.Id Evergreen.V296.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V296.Id.Id Evergreen.V296.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V296.Id.Id Evergreen.V296.Id.CustomEmojiId)
