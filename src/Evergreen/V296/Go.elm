module Evergreen.V296.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V296.Id.Id Evergreen.V296.Id.UserId
    , whitePlayer : Evergreen.V296.Id.Id Evergreen.V296.Id.UserId
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , blackPlayer : Evergreen.V296.User.FrontendUser
    , whitePlayer : Evergreen.V296.User.FrontendUser
    }
