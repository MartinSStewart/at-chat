module Evergreen.V296.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V296.Id.Id Evergreen.V296.FileStatus.FileId)
    | EmbedImageAnchor Int


type AnchorType
    = MessageAnchor Evergreen.V296.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V296.Id.ThreadRoute Date.Date
