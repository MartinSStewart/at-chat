module Evergreen.V296.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V296.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V296.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V296.FileName.FileName Int ContentType Effect.Http.Error
