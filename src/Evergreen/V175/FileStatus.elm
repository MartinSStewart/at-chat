module Evergreen.V175.FileStatus exposing (..)

import Effect.Http
import Evergreen.V175.Coord
import Evergreen.V175.CssPixels
import Evergreen.V175.FileName
...
type alias FileData =
    { fileName : Evergreen.V175.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V175.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V175.FileName.FileName Int ContentType Effect.Http.Error
