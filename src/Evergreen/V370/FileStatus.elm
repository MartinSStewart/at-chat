module Evergreen.V370.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V370.Coord.Coord Evergreen.V370.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V370.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V370.Coord.Coord Evergreen.V370.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V370.Coord.Coord Evergreen.V370.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V370.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V370.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
