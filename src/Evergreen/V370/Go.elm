module Evergreen.V370.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V370.Id.Id Evergreen.V370.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V370.Id.Id Evergreen.V370.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V370.User.FrontendUser
    , joinedUser : Maybe Evergreen.V370.User.FrontendUser
    }
