module Evergreen.V370.WordSpellingGame exposing (..)
...
type alias Player =
    ...
    , tray : Evergreen.V370.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V370.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V370.OneOrGreater.OneOrGreater
    }
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V370.Id.Id Evergreen.V370.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V370.Id.Id Evergreen.V370.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V370.Id.Id Evergreen.V370.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard )) Shared
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V370.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V370.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V370.Go.TimeControl
    , traySize : Evergreen.V370.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V370.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V370.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V370.OneOrGreater.OneOrGreater
    }


type Action
    = PlaceWord PlacedWord (Evergreen.V370.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V370.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V370.Id.Id Evergreen.V370.Id.UserId)
