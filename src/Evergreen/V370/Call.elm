module Evergreen.V370.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V370.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V370.Id.Viewing_DmId
    | GuildRoomId Evergreen.V370.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V370.Id.Id Evergreen.V370.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V370.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V370.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V370.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V370.NonemptyDict.NonemptyDict ( Evergreen.V370.Id.Id Evergreen.V370.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V370.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V370.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V370.Id.Id Evergreen.V370.Id.UserId, Effect.Lamdera.ClientId ) Float
