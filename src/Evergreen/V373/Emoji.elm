module Evergreen.V373.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V373.Id.Id Evergreen.V373.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V373.Id.Id Evergreen.V373.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V373.Id.Id Evergreen.V373.Id.CustomEmojiId)
