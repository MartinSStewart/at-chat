module Evergreen.V373.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V373.Id.Id Evergreen.V373.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V373.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V373.Id.ThreadRoute Date.Date
