module Evergreen.V373.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V373.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V373.Id.Viewing_DmId
    | GuildRoomId Evergreen.V373.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V373.Id.Id Evergreen.V373.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V373.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V373.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V373.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V373.NonemptyDict.NonemptyDict ( Evergreen.V373.Id.Id Evergreen.V373.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V373.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V373.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V373.Id.Id Evergreen.V373.Id.UserId, Effect.Lamdera.ClientId ) Float
