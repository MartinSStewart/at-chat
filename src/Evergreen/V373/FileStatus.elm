module Evergreen.V373.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V373.Coord.Coord Evergreen.V373.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V373.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V373.Coord.Coord Evergreen.V373.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V373.Coord.Coord Evergreen.V373.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V373.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V373.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
