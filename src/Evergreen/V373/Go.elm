module Evergreen.V373.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V373.Id.Id Evergreen.V373.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V373.Id.Id Evergreen.V373.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V373.User.FrontendUser
    , joinedUser : Maybe Evergreen.V373.User.FrontendUser
    }
