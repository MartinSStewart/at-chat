module Evergreen.V217.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V217.Id.Id Evergreen.V217.Id.UserId
    , whitePlayer : Evergreen.V217.Id.Id Evergreen.V217.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V217.Id.Id Evergreen.V217.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V217.Id.Id Evergreen.V217.Id.ChannelMessageId))
    | PressedReset
