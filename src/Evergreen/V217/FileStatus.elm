module Evergreen.V217.FileStatus exposing (..)

import Effect.Http
import Evergreen.V217.Coord
import Evergreen.V217.CssPixels
import Evergreen.V217.FileName
...
type alias ImageMetadata =
    { imageSize : Evergreen.V217.Coord.Coord Evergreen.V217.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V217.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V217.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V217.FileName.FileName Int ContentType Effect.Http.Error
