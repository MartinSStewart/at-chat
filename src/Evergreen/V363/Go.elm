module Evergreen.V363.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V363.Id.Id Evergreen.V363.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V363.Id.Id Evergreen.V363.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V363.User.FrontendUser
    , joinedUser : Maybe Evergreen.V363.User.FrontendUser
    }
