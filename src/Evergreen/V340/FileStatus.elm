module Evergreen.V340.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V340.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V340.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V340.FileName.FileName Int ContentType Effect.Http.Error
