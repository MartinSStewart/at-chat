module Evergreen.V340.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V340.Id.Id Evergreen.V340.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V340.Id.Id Evergreen.V340.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V340.Id.Id Evergreen.V340.Id.CustomEmojiId)
