module Evergreen.V340.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V340.Id.Id Evergreen.V340.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V340.Id.Id Evergreen.V340.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V340.User.FrontendUser
    , joinedUser : Maybe Evergreen.V340.User.FrontendUser
    }
