module Evergreen.V163.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V163.Coord.Coord Evergreen.V163.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V163.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V163.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V163.FileName.FileName Int ContentType Effect.Http.Error
