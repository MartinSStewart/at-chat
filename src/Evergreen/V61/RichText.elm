module Evergreen.V61.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V61.Id.Id Evergreen.V61.Id.UserId)
    ...
    | AttachedFile (Evergreen.V61.Id.Id Evergreen.V61.FileStatus.FileId)
