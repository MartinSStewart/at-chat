module Evergreen.V209.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V209.Coord.Coord Evergreen.V209.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V209.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V209.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V209.FileName.FileName Int ContentType Effect.Http.Error
