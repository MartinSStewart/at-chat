module Evergreen.V309.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V309.Id.Id Evergreen.V309.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V309.Id.Id Evergreen.V309.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V309.User.FrontendUser
    , joinedUser : Maybe Evergreen.V309.User.FrontendUser
    }
