module Evergreen.V232.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V232.Id.Id Evergreen.V232.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V232.Id.Id Evergreen.V232.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V232.Id.Id Evergreen.V232.Id.CustomEmojiId)
