module Evergreen.V232.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V232.Id.Id Evergreen.V232.Id.UserId
    , whitePlayer : Evergreen.V232.Id.Id Evergreen.V232.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V232.Id.Id Evergreen.V232.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V232.Id.Id Evergreen.V232.Id.ChannelMessageId))
    | PressedReset
