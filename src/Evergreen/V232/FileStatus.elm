module Evergreen.V232.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V232.Coord.Coord Evergreen.V232.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V232.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V232.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V232.FileName.FileName Int ContentType Effect.Http.Error
