module Evergreen.V346.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V346.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V346.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V346.FileName.FileName Int ContentType Effect.Http.Error
