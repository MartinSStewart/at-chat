module Evergreen.V346.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V346.Id.Id Evergreen.V346.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V346.Id.Id Evergreen.V346.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V346.User.FrontendUser
    , joinedUser : Maybe Evergreen.V346.User.FrontendUser
    }
