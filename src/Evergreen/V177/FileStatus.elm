module Evergreen.V177.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V177.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V177.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V177.FileName.FileName Int ContentType Effect.Http.Error
