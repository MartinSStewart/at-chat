module Evergreen.V161.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V161.Coord.Coord Evergreen.V161.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V161.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V161.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V161.FileName.FileName Int ContentType Effect.Http.Error
