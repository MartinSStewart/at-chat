module Evergreen.V250.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V250.Id.Id Evergreen.V250.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V250.Id.Id Evergreen.V250.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V250.Id.Id Evergreen.V250.Id.CustomEmojiId)
