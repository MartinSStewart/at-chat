module Evergreen.V102.FileStatus exposing (..)

import Effect.Http
import Evergreen.V102.Coord
import Evergreen.V102.CssPixels
import Evergreen.V102.FileName
...
type alias ImageMetadata =
    { imageSize : Evergreen.V102.Coord.Coord Evergreen.V102.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V102.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V102.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V102.FileName.FileName Int ContentType Effect.Http.Error
