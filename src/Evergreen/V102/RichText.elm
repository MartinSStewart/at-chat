module Evergreen.V102.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V102.Id.Id Evergreen.V102.Id.UserId)
    ...
    | AttachedFile (Evergreen.V102.Id.Id Evergreen.V102.FileStatus.FileId)
