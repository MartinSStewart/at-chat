module Evergreen.V283.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V283.Id.Id Evergreen.V283.Id.UserId
    , whitePlayer : Evergreen.V283.Id.Id Evergreen.V283.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V283.SecretId.SecretId Evergreen.V283.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V283.User.FrontendUser
    , whitePlayer : Evergreen.V283.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V283.Id.Id Evergreen.V283.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V283.Id.Id Evergreen.V283.Id.ChannelMessageId) (Evergreen.V283.UserSession.ToBeFilledInByBackend (Evergreen.V283.SecretId.SecretId Evergreen.V283.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V283.Id.Id Evergreen.V283.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V283.Id.Id Evergreen.V283.Id.ChannelMessageId)
