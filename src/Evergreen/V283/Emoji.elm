module Evergreen.V283.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V283.Id.Id Evergreen.V283.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V283.Id.Id Evergreen.V283.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V283.Id.Id Evergreen.V283.Id.CustomEmojiId)
