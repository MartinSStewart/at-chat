module Evergreen.V283.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V283.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V283.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V283.FileName.FileName Int ContentType Effect.Http.Error
