module Evergreen.V137.Discord exposing (..)
...
type alias UserAuth =
    { token : String
    , userAgent : String
    , xSuperProperties : Evergreen.V137.SafeJson.SafeJson
    }
...
type alias PartialUser =
    { id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.UserId
    , username : String
...
type alias Attachment =
    { id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.AttachmentId
    , filename : String
    , size : Int
    , url : String
    , proxyUrl : String
...
type EmojiType
    ...
    | CustomEmojiType
        { id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.CustomEmojiId
        , name : Maybe String
        }
...
type alias EmojiData =
    { type_ : EmojiType
    , roles : OptionalData (List (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.RoleId))
...
type alias Message =
    { id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.MessageId
    , channelId : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ChannelId
    , guildId : OptionalData (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.GuildId)
    , author : User
    , content : String
    ...
    , mentionRoles : List (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.RoleId)
    , attachments : List Attachment
    , reactions : OptionalData (List Reaction)
    , pinned : Bool
    , webhookId : OptionalData (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.WebhookId)
    , type_ : MessageType
    , flags : OptionalData Int
...
type alias Channel =
    { id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ChannelId
    , type_ : ChannelType
    , guildId : OptionalData (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.GuildId)
    ...
    , lastMessageId : OptionalData (Maybe (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.MessageId))
    ...
    , ownerId : OptionalData (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.UserId)
    , applicationId : OptionalData (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ApplicationId)
    , parentId : OptionalData (Maybe (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ChannelId))
...
type alias GatewayGuildProperties =
    ...
    , id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.GuildId
    , systemChannelId : Maybe (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ChannelId)
    , afkChannelId : Maybe (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ChannelId)
    , name : String
    , maxMembers : Maybe Int
    , nsfw : Bool
    , description : Maybe String
    , preferredLocale : String
    , rulesChannelId : Maybe (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.ChannelId)
    , ownerId : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.UserId
    }
...
type alias Sticker =
    { id : Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.StickerId
    , packId : OptionalData (Evergreen.V137.Discord.Id.Id Evergreen.V137.Discord.Id.StickerPackId)
    , name : String
    , description : Maybe String
    , tags : String
