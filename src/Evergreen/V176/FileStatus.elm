module Evergreen.V176.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V176.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V176.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V176.FileName.FileName Int ContentType Effect.Http.Error
