module Evergreen.V375.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V375.Id.Id Evergreen.V375.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V375.Id.Id Evergreen.V375.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V375.User.FrontendUser
    , joinedUser : Maybe Evergreen.V375.User.FrontendUser
    }
