module Evergreen.V375.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V375.Coord.Coord Evergreen.V375.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V375.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V375.Coord.Coord Evergreen.V375.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V375.Coord.Coord Evergreen.V375.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V375.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V375.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
