module Evergreen.V375.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V375.Id.Id Evergreen.V375.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V375.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V375.Id.ThreadRoute Date.Date
