module Evergreen.V375.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V375.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V375.Id.Viewing_DmId
    | GuildRoomId Evergreen.V375.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V375.Id.Id Evergreen.V375.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V375.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V375.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V375.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V375.NonemptyDict.NonemptyDict ( Evergreen.V375.Id.Id Evergreen.V375.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V375.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V375.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V375.Id.Id Evergreen.V375.Id.UserId, Effect.Lamdera.ClientId ) Float
