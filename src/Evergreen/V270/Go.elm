module Evergreen.V270.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V270.Id.Id Evergreen.V270.Id.UserId
    , whitePlayer : Evergreen.V270.Id.Id Evergreen.V270.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V270.SecretId.SecretId Evergreen.V270.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V270.User.FrontendUser
    , whitePlayer : Evergreen.V270.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V270.Id.Id Evergreen.V270.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V270.Id.Id Evergreen.V270.Id.ChannelMessageId) (Evergreen.V270.UserSession.ToBeFilledInByBackend (Evergreen.V270.SecretId.SecretId Evergreen.V270.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V270.Id.Id Evergreen.V270.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V270.Id.Id Evergreen.V270.Id.ChannelMessageId)
