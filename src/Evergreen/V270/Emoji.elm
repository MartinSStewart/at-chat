module Evergreen.V270.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V270.Id.Id Evergreen.V270.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V270.Id.Id Evergreen.V270.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V270.Id.Id Evergreen.V270.Id.CustomEmojiId)
