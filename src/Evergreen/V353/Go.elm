module Evergreen.V353.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V353.Id.Id Evergreen.V353.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V353.Id.Id Evergreen.V353.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V353.User.FrontendUser
    , joinedUser : Maybe Evergreen.V353.User.FrontendUser
    }
