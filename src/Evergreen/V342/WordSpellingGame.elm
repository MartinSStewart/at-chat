module Evergreen.V342.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V342.Id.Id Evergreen.V342.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V342.Id.Id Evergreen.V342.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V342.Id.Id Evergreen.V342.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard ))
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V342.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V342.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V342.Go.TimeControl
    , traySize : Evergreen.V342.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V342.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V342.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V342.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V342.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V342.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias Player =
    { userId : Evergreen.V342.Id.Id Evergreen.V342.Id.UserId
    , tray : Evergreen.V342.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V342.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V342.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V342.Id.Id Evergreen.V342.Id.UserId)
    , highlightedWordCells : Dict.Dict ( Int, Int ) LetterOrWildcard
    , scrollPosition : Evergreen.V342.Scroll.ScrollPosition
