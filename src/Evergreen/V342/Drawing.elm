module Evergreen.V342.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V342.Id.Id Evergreen.V342.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V342.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V342.Id.ThreadRoute Date.Date
