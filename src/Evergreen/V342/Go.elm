module Evergreen.V342.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V342.Id.Id Evergreen.V342.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V342.Id.Id Evergreen.V342.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V342.User.FrontendUser
    , joinedUser : Maybe Evergreen.V342.User.FrontendUser
    }
