module Evergreen.V342.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V342.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V342.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V342.FileName.FileName Int ContentType Effect.Http.Error
