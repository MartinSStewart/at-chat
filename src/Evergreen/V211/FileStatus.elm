module Evergreen.V211.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V211.Coord.Coord Evergreen.V211.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V211.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V211.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V211.FileName.FileName Int ContentType Effect.Http.Error
