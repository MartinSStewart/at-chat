module Evergreen.V134.Discord exposing (..)
...
type alias UserAuth =
    { token : String
    , userAgent : String
    , xSuperProperties : Evergreen.V134.SafeJson.SafeJson
    }
...
type alias PartialUser =
    { id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.UserId
    , username : String
...
type alias Attachment =
    { id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.AttachmentId
    , filename : String
    , size : Int
    , url : String
    , proxyUrl : String
...
type EmojiType
    ...
    | CustomEmojiType
        { id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.CustomEmojiId
        , name : Maybe String
        }
...
type alias EmojiData =
    { type_ : EmojiType
    , roles : OptionalData (List (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.RoleId))
...
type alias Message =
    { id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.MessageId
    , channelId : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ChannelId
    , guildId : OptionalData (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.GuildId)
    , author : User
    , content : String
    ...
    , mentionRoles : List (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.RoleId)
    , attachments : List Attachment
    , reactions : OptionalData (List Reaction)
    , pinned : Bool
    , webhookId : OptionalData (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.WebhookId)
    , type_ : MessageType
    , flags : OptionalData Int
...
type alias Channel =
    { id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ChannelId
    , type_ : ChannelType
    , guildId : OptionalData (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.GuildId)
    ...
    , lastMessageId : OptionalData (Maybe (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.MessageId))
    ...
    , ownerId : OptionalData (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.UserId)
    , applicationId : OptionalData (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ApplicationId)
    , parentId : OptionalData (Maybe (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ChannelId))
...
type alias GatewayGuildProperties =
    ...
    , id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.GuildId
    , systemChannelId : Maybe (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ChannelId)
    , afkChannelId : Maybe (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ChannelId)
    , name : String
    , maxMembers : Maybe Int
    , nsfw : Bool
    , description : Maybe String
    , preferredLocale : String
    , rulesChannelId : Maybe (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.ChannelId)
    , ownerId : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.UserId
    }
...
type alias Sticker =
    { id : Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.StickerId
    , packId : OptionalData (Evergreen.V134.Discord.Id.Id Evergreen.V134.Discord.Id.StickerPackId)
    , name : String
    , description : Maybe String
    , tags : String
