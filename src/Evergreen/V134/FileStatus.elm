module Evergreen.V134.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V134.Coord.Coord Evergreen.V134.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V134.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V134.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V134.FileName.FileName Int ContentType Effect.Http.Error
