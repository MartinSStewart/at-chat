module Evergreen.V92.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V92.Id.Id Evergreen.V92.Id.UserId)
    ...
    | AttachedFile (Evergreen.V92.Id.Id Evergreen.V92.FileStatus.FileId)
