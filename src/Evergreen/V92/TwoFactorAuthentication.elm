module Evergreen.V92.TwoFactorAuthentication exposing (..)
...
type alias TwoFactorSetupData =
    { qrCodeUrl : String
    , code : String
    , attempts : SeqDict.SeqDict Int Evergreen.V92.LoginForm.CodeStatus
    }
...
type alias TwoFactorAuthentication =
    { secret : Evergreen.V92.SecretId.SecretId TwoFactorSecret
