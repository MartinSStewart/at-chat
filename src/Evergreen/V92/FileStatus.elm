module Evergreen.V92.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V92.Coord.Coord Evergreen.V92.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V92.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V92.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V92.FileName.FileName Int ContentType Effect.Http.Error
