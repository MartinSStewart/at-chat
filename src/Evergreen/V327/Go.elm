module Evergreen.V327.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V327.Id.Id Evergreen.V327.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V327.Id.Id Evergreen.V327.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V327.User.FrontendUser
    , joinedUser : Maybe Evergreen.V327.User.FrontendUser
    }
