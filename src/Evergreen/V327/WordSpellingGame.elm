module Evergreen.V327.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V327.Id.Id Evergreen.V327.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V327.Id.Id Evergreen.V327.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V327.Id.Id Evergreen.V327.Id.UserId)
    | UserScrolledPastMoves Evergreen.V327.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V327.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V327.Go.TimeControl
    , traySize : Evergreen.V327.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V327.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V327.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V327.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V327.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V327.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias Player =
    { userId : Evergreen.V327.Id.Id Evergreen.V327.Id.UserId
    , tray : Evergreen.V327.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V327.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V327.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V327.Id.Id Evergreen.V327.Id.UserId)
    , scrollPosition : Evergreen.V327.Scroll.ScrollPosition
