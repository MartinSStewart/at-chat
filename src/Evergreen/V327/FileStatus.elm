module Evergreen.V327.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V327.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V327.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V327.FileName.FileName Int ContentType Effect.Http.Error
