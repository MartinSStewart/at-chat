module Evergreen.V341.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V341.Id.Id Evergreen.V341.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V341.Id.Id Evergreen.V341.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V341.User.FrontendUser
    , joinedUser : Maybe Evergreen.V341.User.FrontendUser
    }
