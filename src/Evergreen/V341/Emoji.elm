module Evergreen.V341.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V341.Id.Id Evergreen.V341.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V341.Id.Id Evergreen.V341.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V341.Id.Id Evergreen.V341.Id.CustomEmojiId)
