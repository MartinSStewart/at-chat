module Evergreen.V341.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V341.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V341.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V341.FileName.FileName Int ContentType Effect.Http.Error
