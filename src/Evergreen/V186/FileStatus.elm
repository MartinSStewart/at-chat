module Evergreen.V186.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V186.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V186.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V186.FileName.FileName Int ContentType Effect.Http.Error
