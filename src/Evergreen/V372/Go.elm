module Evergreen.V372.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V372.Id.Id Evergreen.V372.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V372.Id.Id Evergreen.V372.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V372.User.FrontendUser
    , joinedUser : Maybe Evergreen.V372.User.FrontendUser
    }
