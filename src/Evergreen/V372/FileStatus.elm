module Evergreen.V372.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V372.Coord.Coord Evergreen.V372.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V372.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V372.Coord.Coord Evergreen.V372.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V372.Coord.Coord Evergreen.V372.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V372.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V372.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
