module Evergreen.V104.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V104.Id.Id Evergreen.V104.Id.UserId)
    ...
    | AttachedFile (Evergreen.V104.Id.Id Evergreen.V104.FileStatus.FileId)
