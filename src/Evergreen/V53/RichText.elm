module Evergreen.V53.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V53.Id.Id Evergreen.V53.Id.UserId)
    ...
    | AttachedFile (Evergreen.V53.Id.Id Evergreen.V53.FileStatus.FileId)
