module Evergreen.V101.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V101.Id.Id Evergreen.V101.Id.UserId)
    ...
    | AttachedFile (Evergreen.V101.Id.Id Evergreen.V101.FileStatus.FileId)
