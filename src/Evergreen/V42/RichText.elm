module Evergreen.V42.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V42.Id.Id Evergreen.V42.Id.UserId)
    ...
    | AttachedFile (Evergreen.V42.Id.Id Evergreen.V42.FileStatus.FileId)
