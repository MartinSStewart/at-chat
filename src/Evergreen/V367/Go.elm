module Evergreen.V367.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V367.Id.Id Evergreen.V367.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V367.Id.Id Evergreen.V367.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V367.User.FrontendUser
    , joinedUser : Maybe Evergreen.V367.User.FrontendUser
    }
