module Evergreen.V367.WordSpellingGame exposing (..)
...
type alias Player =
    ...
    , tray : Evergreen.V367.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V367.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V367.OneOrGreater.OneOrGreater
    }
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V367.Id.Id Evergreen.V367.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V367.Id.Id Evergreen.V367.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V367.Id.Id Evergreen.V367.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard )) Shared
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V367.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V367.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V367.Go.TimeControl
    , traySize : Evergreen.V367.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V367.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V367.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V367.OneOrGreater.OneOrGreater
    }


type Action
    = PlaceWord PlacedWord (Evergreen.V367.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V367.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V367.Id.Id Evergreen.V367.Id.UserId)
