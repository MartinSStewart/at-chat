module Evergreen.V173.FileStatus exposing (..)

import Effect.Http
import Evergreen.V173.Coord
import Evergreen.V173.CssPixels
import Evergreen.V173.FileName
...
type alias FileData =
    { fileName : Evergreen.V173.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V173.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V173.FileName.FileName Int ContentType Effect.Http.Error
