module Evergreen.V279.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V279.Id.Id Evergreen.V279.Id.UserId
    , whitePlayer : Evergreen.V279.Id.Id Evergreen.V279.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V279.SecretId.SecretId Evergreen.V279.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V279.User.FrontendUser
    , whitePlayer : Evergreen.V279.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V279.Id.Id Evergreen.V279.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V279.Id.Id Evergreen.V279.Id.ChannelMessageId) (Evergreen.V279.UserSession.ToBeFilledInByBackend (Evergreen.V279.SecretId.SecretId Evergreen.V279.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V279.Id.Id Evergreen.V279.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V279.Id.Id Evergreen.V279.Id.ChannelMessageId)
