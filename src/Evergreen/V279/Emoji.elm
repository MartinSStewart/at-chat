module Evergreen.V279.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V279.Id.Id Evergreen.V279.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V279.Id.Id Evergreen.V279.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V279.Id.Id Evergreen.V279.Id.CustomEmojiId)
