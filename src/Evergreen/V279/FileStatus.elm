module Evergreen.V279.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V279.Coord.Coord Evergreen.V279.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V279.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V279.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V279.FileName.FileName Int ContentType Effect.Http.Error
