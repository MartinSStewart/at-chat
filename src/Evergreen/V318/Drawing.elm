module Evergreen.V318.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V318.Id.Id Evergreen.V318.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V318.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V318.Id.ThreadRoute Date.Date
