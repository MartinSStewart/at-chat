module Evergreen.V318.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V318.Id.Id Evergreen.V318.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V318.Id.Id Evergreen.V318.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V318.User.FrontendUser
    , joinedUser : Maybe Evergreen.V318.User.FrontendUser
    }
