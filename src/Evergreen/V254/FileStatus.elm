module Evergreen.V254.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V254.Coord.Coord Evergreen.V254.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V254.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V254.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V254.FileName.FileName Int ContentType Effect.Http.Error
