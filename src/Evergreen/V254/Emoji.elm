module Evergreen.V254.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V254.Id.Id Evergreen.V254.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V254.Id.Id Evergreen.V254.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V254.Id.Id Evergreen.V254.Id.CustomEmojiId)
