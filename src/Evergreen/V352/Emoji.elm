module Evergreen.V352.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V352.Id.Id Evergreen.V352.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V352.Id.Id Evergreen.V352.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V352.Id.Id Evergreen.V352.Id.CustomEmojiId)
