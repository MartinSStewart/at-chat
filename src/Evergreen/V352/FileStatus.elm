module Evergreen.V352.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V352.Coord.Coord Evergreen.V352.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V352.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V352.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V352.FileName.FileName Int ContentType Effect.Http.Error
