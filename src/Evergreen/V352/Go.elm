module Evergreen.V352.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V352.Id.Id Evergreen.V352.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V352.Id.Id Evergreen.V352.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V352.User.FrontendUser
    , joinedUser : Maybe Evergreen.V352.User.FrontendUser
    }
