module Evergreen.V285.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V285.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V285.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V285.FileName.FileName Int ContentType Effect.Http.Error
