module Evergreen.V360.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V360.Coord.Coord Evergreen.V360.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V360.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V360.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V360.FileName.FileName Int ContentType Effect.Http.Error
