module Evergreen.V360.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V360.Id.Id Evergreen.V360.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V360.Id.Id Evergreen.V360.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V360.User.FrontendUser
    , joinedUser : Maybe Evergreen.V360.User.FrontendUser
    }
