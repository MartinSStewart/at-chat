module Evergreen.V360.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V360.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V360.Id.Viewing_DmId
    | GuildRoomId Evergreen.V360.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V360.Id.Id Evergreen.V360.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V360.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V360.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V360.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V360.NonemptyDict.NonemptyDict ( Evergreen.V360.Id.Id Evergreen.V360.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V360.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V360.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V360.Id.Id Evergreen.V360.Id.UserId, Effect.Lamdera.ClientId ) Float
