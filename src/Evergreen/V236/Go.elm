module Evergreen.V236.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V236.Id.Id Evergreen.V236.Id.UserId
    , whitePlayer : Evergreen.V236.Id.Id Evergreen.V236.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V236.Id.Id Evergreen.V236.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V236.Id.Id Evergreen.V236.Id.ChannelMessageId))
    | PressedReset
