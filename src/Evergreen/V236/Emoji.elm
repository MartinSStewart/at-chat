module Evergreen.V236.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V236.Id.Id Evergreen.V236.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V236.Id.Id Evergreen.V236.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V236.Id.Id Evergreen.V236.Id.CustomEmojiId)
