module Evergreen.V236.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V236.Coord.Coord Evergreen.V236.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V236.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V236.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V236.FileName.FileName Int ContentType Effect.Http.Error
