module Evergreen.V117.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V117.Coord.Coord Evergreen.V117.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V117.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V117.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V117.FileName.FileName Int ContentType Effect.Http.Error
