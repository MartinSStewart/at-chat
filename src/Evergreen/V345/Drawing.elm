module Evergreen.V345.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V345.Id.Id Evergreen.V345.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V345.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V345.Id.ThreadRoute Date.Date
