module Evergreen.V345.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V345.Id.Id Evergreen.V345.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V345.Id.Id Evergreen.V345.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V345.Id.Id Evergreen.V345.Id.CustomEmojiId)
