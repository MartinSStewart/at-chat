module Evergreen.V345.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V345.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V345.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V345.FileName.FileName Int ContentType Effect.Http.Error
