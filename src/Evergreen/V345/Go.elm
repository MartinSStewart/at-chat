module Evergreen.V345.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V345.Id.Id Evergreen.V345.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V345.Id.Id Evergreen.V345.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V345.User.FrontendUser
    , joinedUser : Maybe Evergreen.V345.User.FrontendUser
    }
