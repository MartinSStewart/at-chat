module Evergreen.V385.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V385.Id.Id Evergreen.V385.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V385.Id.Id Evergreen.V385.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V385.User.FrontendUser
    , joinedUser : Maybe Evergreen.V385.User.FrontendUser
    }
