module Evergreen.V316.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V316.Id.Id Evergreen.V316.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V316.Id.Id Evergreen.V316.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V316.User.FrontendUser
    , joinedUser : Maybe Evergreen.V316.User.FrontendUser
    }
