module Evergreen.V348.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V348.Id.Id Evergreen.V348.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V348.Id.Id Evergreen.V348.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V348.Id.Id Evergreen.V348.Id.CustomEmojiId)
