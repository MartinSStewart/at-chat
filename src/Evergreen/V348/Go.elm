module Evergreen.V348.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V348.Id.Id Evergreen.V348.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V348.Id.Id Evergreen.V348.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V348.User.FrontendUser
    , joinedUser : Maybe Evergreen.V348.User.FrontendUser
    }
