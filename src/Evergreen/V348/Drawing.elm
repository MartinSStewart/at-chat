module Evergreen.V348.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V348.Id.Id Evergreen.V348.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V348.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V348.Id.ThreadRoute Date.Date
