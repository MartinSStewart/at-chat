module Evergreen.V348.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V348.Coord.Coord Evergreen.V348.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V348.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V348.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V348.FileName.FileName Int ContentType Effect.Http.Error
