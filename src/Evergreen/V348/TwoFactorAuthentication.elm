module Evergreen.V348.TwoFactorAuthentication exposing (..)
...
type alias TwoFactorSetupData =
    { qrCodeUrl : String
    , code : String
    , attempts : SeqDict.SeqDict Int Evergreen.V348.LoginForm.CodeStatus
    }
...
type alias TwoFactorAuthentication =
    { secret : Evergreen.V348.SecretId.SecretId TwoFactorSecret
