module Evergreen.V171.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V171.Coord.Coord Evergreen.V171.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V171.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V171.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V171.FileName.FileName Int ContentType Effect.Http.Error
