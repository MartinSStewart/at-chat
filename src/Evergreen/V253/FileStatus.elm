module Evergreen.V253.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V253.Coord.Coord Evergreen.V253.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V253.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V253.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V253.FileName.FileName Int ContentType Effect.Http.Error
