module Evergreen.V253.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V253.Id.Id Evergreen.V253.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V253.Id.Id Evergreen.V253.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V253.Id.Id Evergreen.V253.Id.CustomEmojiId)
