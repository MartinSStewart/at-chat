module Evergreen.V136.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V136.Coord.Coord Evergreen.V136.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V136.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V136.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V136.FileName.FileName Int ContentType Effect.Http.Error
