module Evergreen.V383.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V383.Id.Id Evergreen.V383.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V383.Id.Id Evergreen.V383.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V383.User.FrontendUser
    , joinedUser : Maybe Evergreen.V383.User.FrontendUser
    }
