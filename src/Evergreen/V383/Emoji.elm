module Evergreen.V383.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V383.Id.Id Evergreen.V383.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V383.Id.Id Evergreen.V383.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V383.Id.Id Evergreen.V383.Id.CustomEmojiId)
