module Evergreen.V354.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V354.Coord.Coord Evergreen.V354.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V354.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V354.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V354.FileName.FileName Int ContentType Effect.Http.Error
