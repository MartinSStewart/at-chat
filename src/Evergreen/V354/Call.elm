module Evergreen.V354.Call exposing (..)
...
type alias MediaDevice =
    { deviceId : Evergreen.V354.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type CallId
    = DmRoomId Evergreen.V354.Id.Viewing_DmId
    | GuildRoomId Evergreen.V354.Id.Viewing_ChannelId


type alias ConnectionId =
    { roomId : CallId
    , otherClientId : ( Evergreen.V354.Id.Id Evergreen.V354.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type FromJs
    = FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V354.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V354.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V354.IdString.IdString MediaDeviceId)
    | PressedToggleMute
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict CallId (Evergreen.V354.NonemptyDict.NonemptyDict ( Evergreen.V354.Id.Id Evergreen.V354.Id.UserId, Effect.Lamdera.ClientId ) RemoteCallData)
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V354.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V354.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V354.Id.Id Evergreen.V354.Id.UserId, Effect.Lamdera.ClientId ) Float
