module Evergreen.V354.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V354.Id.Id Evergreen.V354.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V354.Id.Id Evergreen.V354.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V354.Id.Id Evergreen.V354.Id.CustomEmojiId)
