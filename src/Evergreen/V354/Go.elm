module Evergreen.V354.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V354.Id.Id Evergreen.V354.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V354.Id.Id Evergreen.V354.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V354.User.FrontendUser
    , joinedUser : Maybe Evergreen.V354.User.FrontendUser
    }
