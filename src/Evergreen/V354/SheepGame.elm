module Evergreen.V354.SheepGame exposing (..)
...
type GameMsg
    ...
    | PressedLockAnswers
    | TypedGroup (Evergreen.V354.Id.Id Evergreen.V354.Id.UserId) Int String
...
type alias Content =
    List.Nonempty.Nonempty (Evergreen.V354.RichText.RichText (Evergreen.V354.Id.Id Evergreen.V354.Id.UserId))
...
type Action
    ...
    | LockedAnswers
    | ChangedGroup (Evergreen.V354.Id.Id Evergreen.V354.Id.UserId) Int String
...
type alias Shared =
    { phase : Phase
    , answers : SeqDict.SeqDict (Evergreen.V354.Id.Id Evergreen.V354.Id.UserId) (Array.Array (Maybe Content))
    , groups : SeqDict.SeqDict ( Evergreen.V354.Id.Id Evergreen.V354.Id.UserId, Int ) String
