module Evergreen.V354.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V354.Id.Id Evergreen.V354.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V354.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V354.Id.ThreadRoute Date.Date
