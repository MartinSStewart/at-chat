module Evergreen.V277.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V277.Coord.Coord Evergreen.V277.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V277.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V277.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V277.FileName.FileName Int ContentType Effect.Http.Error
