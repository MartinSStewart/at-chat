module Evergreen.V277.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V277.Id.Id Evergreen.V277.Id.UserId
    , whitePlayer : Evergreen.V277.Id.Id Evergreen.V277.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V277.SecretId.SecretId Evergreen.V277.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V277.User.FrontendUser
    , whitePlayer : Evergreen.V277.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V277.Id.Id Evergreen.V277.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V277.Id.Id Evergreen.V277.Id.ChannelMessageId) (Evergreen.V277.UserSession.ToBeFilledInByBackend (Evergreen.V277.SecretId.SecretId Evergreen.V277.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V277.Id.Id Evergreen.V277.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V277.Id.Id Evergreen.V277.Id.ChannelMessageId)
