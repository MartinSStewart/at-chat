module Evergreen.V289.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V289.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V289.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V289.FileName.FileName Int ContentType Effect.Http.Error
