module Evergreen.V289.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V289.Id.Id Evergreen.V289.Id.UserId
    , whitePlayer : Evergreen.V289.Id.Id Evergreen.V289.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V289.SecretId.SecretId Evergreen.V289.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V289.User.FrontendUser
    , whitePlayer : Evergreen.V289.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V289.Id.Id Evergreen.V289.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V289.Id.Id Evergreen.V289.Id.ChannelMessageId) (Evergreen.V289.UserSession.ToBeFilledInByBackend (Evergreen.V289.SecretId.SecretId Evergreen.V289.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V289.Id.Id Evergreen.V289.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V289.Id.Id Evergreen.V289.Id.ChannelMessageId)
