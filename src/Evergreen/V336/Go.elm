module Evergreen.V336.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V336.Id.Id Evergreen.V336.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V336.Id.Id Evergreen.V336.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V336.User.FrontendUser
    , joinedUser : Maybe Evergreen.V336.User.FrontendUser
    }
