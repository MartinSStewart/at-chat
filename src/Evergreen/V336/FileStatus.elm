module Evergreen.V336.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V336.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V336.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V336.FileName.FileName Int ContentType Effect.Http.Error
