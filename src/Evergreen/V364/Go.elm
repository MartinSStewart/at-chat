module Evergreen.V364.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V364.Id.Id Evergreen.V364.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V364.Id.Id Evergreen.V364.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V364.User.FrontendUser
    , joinedUser : Maybe Evergreen.V364.User.FrontendUser
    }
