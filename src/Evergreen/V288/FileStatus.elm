module Evergreen.V288.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V288.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V288.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V288.FileName.FileName Int ContentType Effect.Http.Error
