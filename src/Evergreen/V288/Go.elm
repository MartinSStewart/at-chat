module Evergreen.V288.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V288.Id.Id Evergreen.V288.Id.UserId
    , whitePlayer : Evergreen.V288.Id.Id Evergreen.V288.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V288.SecretId.SecretId Evergreen.V288.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V288.User.FrontendUser
    , whitePlayer : Evergreen.V288.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V288.Id.Id Evergreen.V288.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V288.Id.Id Evergreen.V288.Id.ChannelMessageId) (Evergreen.V288.UserSession.ToBeFilledInByBackend (Evergreen.V288.SecretId.SecretId Evergreen.V288.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V288.Id.Id Evergreen.V288.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V288.Id.Id Evergreen.V288.Id.ChannelMessageId)
