module Evergreen.V238.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V238.Id.Id Evergreen.V238.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V238.Id.Id Evergreen.V238.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V238.Id.Id Evergreen.V238.Id.CustomEmojiId)
