module Evergreen.V238.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V238.Id.Id Evergreen.V238.Id.UserId
    , whitePlayer : Evergreen.V238.Id.Id Evergreen.V238.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V238.Id.Id Evergreen.V238.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V238.Id.Id Evergreen.V238.Id.ChannelMessageId))
    | PressedReset
