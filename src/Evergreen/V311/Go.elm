module Evergreen.V311.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V311.Id.Id Evergreen.V311.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V311.Id.Id Evergreen.V311.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V311.User.FrontendUser
    , joinedUser : Maybe Evergreen.V311.User.FrontendUser
    }
