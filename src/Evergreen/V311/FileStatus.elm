module Evergreen.V311.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V311.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V311.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V311.FileName.FileName Int ContentType Effect.Http.Error
