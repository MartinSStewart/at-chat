module Evergreen.V359.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V359.User.FrontendUser
    , joinedUser : Maybe Evergreen.V359.User.FrontendUser
    }
