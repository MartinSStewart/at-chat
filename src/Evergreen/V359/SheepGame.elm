module Evergreen.V359.SheepGame exposing (..)
...
type GameMsg
    ...
    | PressedLockAnswers
    | TypedGroup (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId) Int String
...
type alias Content =
    List.Nonempty.Nonempty (Evergreen.V359.RichText.RichText (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId))
...
type Action
    ...
    | LockedAnswers
    | ChangedGroup (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId) Int String
...
type alias Shared =
    { phase : Phase
    , answers : SeqDict.SeqDict (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId) (Array.Array (Maybe Content))
    , groups : SeqDict.SeqDict ( Evergreen.V359.Id.Id Evergreen.V359.Id.UserId, Int ) String
