module Evergreen.V359.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V359.Id.Id Evergreen.V359.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V359.Id.Id Evergreen.V359.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V359.Id.Id Evergreen.V359.Id.CustomEmojiId)
