module Evergreen.V359.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId)
    | MouseEnterWord (List ( ( Int, Int ), LetterOrWildcard ))
    | MouseExitWord
    | UserScrolledPastMoves Evergreen.V359.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V359.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V359.Go.TimeControl
    , traySize : Evergreen.V359.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V359.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V359.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V359.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V359.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
    | Premove PlacedWord (Evergreen.V359.UserSession.ToBeFilledInByBackend IsValid)
    | CancelPremove
...
type alias Player =
    { userId : Evergreen.V359.Id.Id Evergreen.V359.Id.UserId
    , tray : Evergreen.V359.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V359.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V359.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V359.Id.Id Evergreen.V359.Id.UserId)
    , highlightedWordCells : Dict.Dict ( Int, Int ) LetterOrWildcard
    , scrollPosition : Evergreen.V359.Scroll.ScrollPosition
