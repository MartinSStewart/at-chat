module Evergreen.V344.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V344.Id.Id Evergreen.V344.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V344.Id.Id Evergreen.V344.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V344.User.FrontendUser
    , joinedUser : Maybe Evergreen.V344.User.FrontendUser
    }
