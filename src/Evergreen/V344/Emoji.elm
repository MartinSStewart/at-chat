module Evergreen.V344.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V344.Id.Id Evergreen.V344.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V344.Id.Id Evergreen.V344.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V344.Id.Id Evergreen.V344.Id.CustomEmojiId)
