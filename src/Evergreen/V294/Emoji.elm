module Evergreen.V294.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V294.Id.Id Evergreen.V294.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V294.Id.Id Evergreen.V294.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V294.Id.Id Evergreen.V294.Id.CustomEmojiId)
