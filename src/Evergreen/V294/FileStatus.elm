module Evergreen.V294.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V294.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V294.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V294.FileName.FileName Int ContentType Effect.Http.Error
