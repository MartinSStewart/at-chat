module Evergreen.V206.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V206.Coord.Coord Evergreen.V206.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V206.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V206.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V206.FileName.FileName Int ContentType Effect.Http.Error
