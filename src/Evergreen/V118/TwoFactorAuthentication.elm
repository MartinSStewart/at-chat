module Evergreen.V118.TwoFactorAuthentication exposing (..)
...
type alias TwoFactorSetupData =
    { qrCodeUrl : String
    , code : String
    , attempts : SeqDict.SeqDict Int Evergreen.V118.LoginForm.CodeStatus
    }
...
type alias TwoFactorAuthentication =
    { secret : Evergreen.V118.SecretId.SecretId TwoFactorSecret
