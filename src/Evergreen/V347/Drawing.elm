module Evergreen.V347.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V347.Id.Id Evergreen.V347.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V347.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V347.Id.ThreadRoute Date.Date
