module Evergreen.V347.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V347.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V347.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V347.FileName.FileName Int ContentType Effect.Http.Error
