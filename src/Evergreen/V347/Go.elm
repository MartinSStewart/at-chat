module Evergreen.V347.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V347.Id.Id Evergreen.V347.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V347.Id.Id Evergreen.V347.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V347.User.FrontendUser
    , joinedUser : Maybe Evergreen.V347.User.FrontendUser
    }
