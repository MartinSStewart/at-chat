module Evergreen.V347.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V347.Id.Id Evergreen.V347.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V347.Id.Id Evergreen.V347.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V347.Id.Id Evergreen.V347.Id.CustomEmojiId)
