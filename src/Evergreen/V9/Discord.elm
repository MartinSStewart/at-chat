module Evergreen.V9.Discord exposing (..)
...
type alias PartialGuild =
    { id : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.GuildId
    , name : String
...
type alias User =
    { id : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.UserId
    , username : String
...
type EmojiType
    ...
    | CustomEmojiType
        { id : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.CustomEmojiId
        , name : Maybe String
        }
...
type alias EmojiData =
    { type_ : EmojiType
    , roles : OptionalData (List (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.RoleId))
...
type alias GuildMember =
    ...
    , roles : List (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.RoleId)
    , joinedAt : Time.Posix
...
type alias Channel =
    { id : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId
    , type_ : ChannelType
    , guildId : OptionalData (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.GuildId)
    , position : OptionalData Int
    , name : OptionalData String
    , topic : OptionalData (Maybe String)
    , nsfw : OptionalData Bool
    , lastMessageId : OptionalData (Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.MessageId))
    ...
    , ownerId : OptionalData (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.UserId)
    , applicationId : OptionalData (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ApplicationId)
    , parentId : OptionalData (Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId))
...
type alias Guild =
    ...
    , ownerId : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.UserId
    , permissions : OptionalData Permissions
    , region : String
    , afkChannelId : Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId)
    , afkTimeout : Quantity.Quantity Int Duration.Seconds
    , embedEnabled : OptionalData Bool
    , embedChannelId : OptionalData (Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId))
    ...
    , mfaLevel : Int
    , applicationId : Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ApplicationId)
    , widgetEnabled : OptionalData Bool
    , widgetChannelId : OptionalData (Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId))
    , systemChannelId : Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId)
    , systemChannelFlags : Int
    , rulesChannelId : Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId)
    ...
    , publicUpdatesChannelId : Maybe (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId)
...
type alias Attachment =
    { id : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.AttachmentId
    , filename : String
    , size : Int
    , url : String
    , proxyUrl : String
...
type alias Message =
    { id : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.MessageId
    , channelId : Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.ChannelId
    , guildId : OptionalData (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.GuildId)
    , author : User
    , content : String
    ...
    , textToSpeech : Bool
    , mentionEveryone : Bool
    , mentionRoles : List (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.RoleId)
    , attachments : List Attachment
    , reactions : OptionalData (List Reaction)
    , pinned : Bool
    , webhookId : OptionalData (Evergreen.V9.Discord.Id.Id Evergreen.V9.Discord.Id.WebhookId)
    , type_ : MessageType
    , flags : OptionalData Int
    }
