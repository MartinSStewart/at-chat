module Evergreen.V376.FileStatus exposing (..)
...
import Evergreen.V376.FileName
...
type alias VideoMetadata =
    { videoSize : Evergreen.V376.Coord.Coord Evergreen.V376.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V376.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V376.Coord.Coord Evergreen.V376.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V376.Coord.Coord Evergreen.V376.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V376.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V376.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
