module Evergreen.V376.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V376.Id.Id Evergreen.V376.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V376.Id.Id Evergreen.V376.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V376.Id.Id Evergreen.V376.Id.CustomEmojiId)
