module Evergreen.V376.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V376.Id.Id Evergreen.V376.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V376.Id.Id Evergreen.V376.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V376.User.FrontendUser
    , joinedUser : Maybe Evergreen.V376.User.FrontendUser
    }
