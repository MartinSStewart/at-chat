module Evergreen.V377.FileStatus exposing (..)
...
import Evergreen.V377.FileName
...
type alias VideoMetadata =
    { videoSize : Evergreen.V377.Coord.Coord Evergreen.V377.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V377.FileName.FileName
    , fileSize : Int
...
type MeasuredFile
    = MeasuredImage (Evergreen.V377.Coord.Coord Evergreen.V377.CssPixels.CssPixels)
    | MeasuredVideo (Evergreen.V377.Coord.Coord Evergreen.V377.CssPixels.CssPixels) (Maybe Duration.Duration)


type FileStatus
    = FileUploading
        Evergreen.V377.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    ...
    | FileError Evergreen.V377.FileName.FileName Int ContentType Effect.Http.Error IsEncrypted
