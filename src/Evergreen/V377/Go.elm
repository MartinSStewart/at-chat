module Evergreen.V377.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V377.Id.Id Evergreen.V377.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V377.Id.Id Evergreen.V377.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V377.User.FrontendUser
    , joinedUser : Maybe Evergreen.V377.User.FrontendUser
    }
