module Evergreen.V190.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V190.Coord.Coord Evergreen.V190.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V190.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V190.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V190.FileName.FileName Int ContentType Effect.Http.Error
