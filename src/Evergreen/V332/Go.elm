module Evergreen.V332.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V332.Id.Id Evergreen.V332.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V332.Id.Id Evergreen.V332.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V332.User.FrontendUser
    , joinedUser : Maybe Evergreen.V332.User.FrontendUser
    }
