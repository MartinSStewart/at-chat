module Evergreen.V332.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V332.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V332.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V332.FileName.FileName Int ContentType Effect.Http.Error
