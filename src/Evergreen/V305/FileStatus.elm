module Evergreen.V305.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V305.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V305.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V305.FileName.FileName Int ContentType Effect.Http.Error
