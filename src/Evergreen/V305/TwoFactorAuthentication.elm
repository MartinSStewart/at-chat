module Evergreen.V305.TwoFactorAuthentication exposing (..)
...
type alias TwoFactorSetupData =
    { qrCodeUrl : String
    , code : String
    , attempts : SeqDict.SeqDict Int Evergreen.V305.LoginForm.CodeStatus
    }
...
type alias TwoFactorAuthentication =
    { secret : Evergreen.V305.SecretId.SecretId TwoFactorSecret
