module Evergreen.V305.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V305.Id.Id Evergreen.V305.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V305.Id.Id Evergreen.V305.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V305.User.FrontendUser
    , joinedUser : Maybe Evergreen.V305.User.FrontendUser
    }
