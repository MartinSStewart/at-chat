module Evergreen.V183.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V183.Coord.Coord Evergreen.V183.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V183.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V183.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V183.FileName.FileName Int ContentType Effect.Http.Error
