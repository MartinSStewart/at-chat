module Evergreen.V293.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V293.Id.Id Evergreen.V293.Id.UserId
    , whitePlayer : Evergreen.V293.Id.Id Evergreen.V293.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V293.SecretId.SecretId Evergreen.V293.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V293.User.FrontendUser
    , whitePlayer : Evergreen.V293.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V293.Id.Id Evergreen.V293.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V293.Id.Id Evergreen.V293.Id.ChannelMessageId) (Evergreen.V293.UserSession.ToBeFilledInByBackend (Evergreen.V293.SecretId.SecretId Evergreen.V293.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V293.Id.Id Evergreen.V293.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V293.Id.Id Evergreen.V293.Id.ChannelMessageId)
