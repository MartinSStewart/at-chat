module Evergreen.V293.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V293.Id.Id Evergreen.V293.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V293.Id.Id Evergreen.V293.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V293.Id.Id Evergreen.V293.Id.CustomEmojiId)
