module Evergreen.V293.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V293.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V293.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V293.FileName.FileName Int ContentType Effect.Http.Error
