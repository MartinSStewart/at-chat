module Evergreen.V293.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V293.Id.Id Evergreen.V293.FileStatus.FileId)
    | EmbedImageAnchor Int


type AnchorType
    = MessageAnchor Evergreen.V293.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V293.Id.ThreadRoute Date.Date
