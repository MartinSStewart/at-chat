module Evergreen.V223.VoiceChat exposing (..)
...
type RoomId
    = DmRoomId (Evergreen.V223.Id.Id Evergreen.V223.Id.UserId)


type alias ConnectionId =
    { roomId : RoomId
    , otherClientId : ( Evergreen.V223.Id.Id Evergreen.V223.Id.UserId, Effect.Lamdera.ClientId )
    }
...
type alias Local =
    ...
    , voiceChats : SeqDict.SeqDict RoomId (Evergreen.V223.NonemptySet.NonemptySet ( Evergreen.V223.Id.Id Evergreen.V223.Id.UserId, Effect.Lamdera.ClientId ))
    }
...
type alias MediaDevice =
    { deviceId : Evergreen.V223.IdString.IdString MediaDeviceId
    , groupId : String
    , kind : DeviceKind
    , label : String
    }
...
type alias Model =
    ...
    , selectedAudioInputDevice : Maybe (Evergreen.V223.IdString.IdString MediaDeviceId)
    , selectedVideoInputDevice : Maybe (Evergreen.V223.IdString.IdString MediaDeviceId)
    ...
    , volume : SeqDict.SeqDict ( Evergreen.V223.Id.Id Evergreen.V223.Id.UserId, Effect.Lamdera.ClientId ) Float
...
type FromJs
    ...
    | FromJs_GotUserMediaDevices (List MediaDevice) (List (Evergreen.V223.IdString.IdString MediaDeviceId))
...
type Msg
    = SelectedAudioInputDevice (Evergreen.V223.IdString.IdString MediaDeviceId)
    | SelectedVideoInputDevice (Evergreen.V223.IdString.IdString MediaDeviceId)
    | PressedToggleMute
