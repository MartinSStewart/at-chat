module Evergreen.V223.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V223.Coord.Coord Evergreen.V223.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V223.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V223.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V223.FileName.FileName Int ContentType Effect.Http.Error
