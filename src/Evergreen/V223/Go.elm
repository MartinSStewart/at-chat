module Evergreen.V223.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V223.Id.Id Evergreen.V223.Id.UserId
    , whitePlayer : Evergreen.V223.Id.Id Evergreen.V223.Id.UserId
    }
...
type LocalChange
    ...
    | Action (Evergreen.V223.Id.Id Evergreen.V223.Id.ChannelMessageId) ActionWithTime
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V223.Id.Id Evergreen.V223.Id.ChannelMessageId))
    | PressedReset
