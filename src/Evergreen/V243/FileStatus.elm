module Evergreen.V243.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V243.Coord.Coord Evergreen.V243.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V243.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V243.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V243.FileName.FileName Int ContentType Effect.Http.Error
