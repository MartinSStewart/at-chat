module Evergreen.V49.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V49.Id.Id Evergreen.V49.Id.UserId)
    ...
    | AttachedFile (Evergreen.V49.Id.Id Evergreen.V49.FileStatus.FileId)
