module Evergreen.V334.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V334.Id.Id Evergreen.V334.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V334.Id.Id Evergreen.V334.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V334.User.FrontendUser
    , joinedUser : Maybe Evergreen.V334.User.FrontendUser
    }
