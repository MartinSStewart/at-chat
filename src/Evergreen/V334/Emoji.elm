module Evergreen.V334.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V334.Id.Id Evergreen.V334.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V334.Id.Id Evergreen.V334.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V334.Id.Id Evergreen.V334.Id.CustomEmojiId)
