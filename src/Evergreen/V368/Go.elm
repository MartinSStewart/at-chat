module Evergreen.V368.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V368.Id.Id Evergreen.V368.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V368.Id.Id Evergreen.V368.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V368.User.FrontendUser
    , joinedUser : Maybe Evergreen.V368.User.FrontendUser
    }
