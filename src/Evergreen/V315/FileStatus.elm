module Evergreen.V315.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V315.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V315.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V315.FileName.FileName Int ContentType Effect.Http.Error
