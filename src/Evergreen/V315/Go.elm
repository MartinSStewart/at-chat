module Evergreen.V315.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V315.Id.Id Evergreen.V315.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V315.Id.Id Evergreen.V315.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V315.User.FrontendUser
    , joinedUser : Maybe Evergreen.V315.User.FrontendUser
    }
