module Evergreen.V315.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V315.Id.Id Evergreen.V315.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V315.Id.Id Evergreen.V315.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V315.Id.Id Evergreen.V315.Id.CustomEmojiId)
