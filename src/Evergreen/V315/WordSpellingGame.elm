module Evergreen.V315.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V315.Id.Id Evergreen.V315.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V315.Id.Id Evergreen.V315.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V315.Id.Id Evergreen.V315.Id.UserId)
    | UserScrolledPastMoves Evergreen.V315.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V315.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V315.Go.TimeControl
    , traySize : Evergreen.V315.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V315.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V315.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V315.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V315.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
...
type alias Player =
    { userId : Evergreen.V315.Id.Id Evergreen.V315.Id.UserId
    , tray : Evergreen.V315.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
    }
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V315.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V315.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V315.Id.Id Evergreen.V315.Id.UserId)
    , scrollPosition : Evergreen.V315.Scroll.ScrollPosition
    }
