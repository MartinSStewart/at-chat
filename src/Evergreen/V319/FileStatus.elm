module Evergreen.V319.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V319.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V319.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V319.FileName.FileName Int ContentType Effect.Http.Error
