module Evergreen.V319.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V319.Id.Id Evergreen.V319.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V319.Id.Id Evergreen.V319.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V319.User.FrontendUser
    , joinedUser : Maybe Evergreen.V319.User.FrontendUser
    }
