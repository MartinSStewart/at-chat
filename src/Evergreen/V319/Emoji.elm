module Evergreen.V319.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V319.Id.Id Evergreen.V319.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V319.Id.Id Evergreen.V319.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V319.Id.Id Evergreen.V319.Id.CustomEmojiId)
