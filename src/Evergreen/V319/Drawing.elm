module Evergreen.V319.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V319.Id.Id Evergreen.V319.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V319.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V319.Id.ThreadRoute Date.Date
