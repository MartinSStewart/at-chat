module Evergreen.V286.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V286.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V286.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V286.FileName.FileName Int ContentType Effect.Http.Error
