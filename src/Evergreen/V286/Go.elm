module Evergreen.V286.Go exposing (..)
...
type alias ValidatedSetup =
    ...
    , blackPlayer : Evergreen.V286.Id.Id Evergreen.V286.Id.UserId
    , whitePlayer : Evergreen.V286.Id.Id Evergreen.V286.Id.UserId
    }
...
type MatchData
    = MatchData
        ...
        , cache : GameState
        , publicLink : Maybe (Evergreen.V286.SecretId.SecretId Evergreen.V286.Id.GoMatchPublicId)
        }
...
type alias PublicGoMatchData =
    ...
    , actions : Array.Array ActionWithTime
    , cache : GameState
    , blackPlayer : Evergreen.V286.User.FrontendUser
    , whitePlayer : Evergreen.V286.User.FrontendUser
    }
...
type LocalChange
    ...
    | Action (Evergreen.V286.Id.Id Evergreen.V286.Id.ChannelMessageId) ActionWithTime
    | CreatePublicLink (Evergreen.V286.Id.Id Evergreen.V286.Id.ChannelMessageId) (Evergreen.V286.UserSession.ToBeFilledInByBackend (Evergreen.V286.SecretId.SecretId Evergreen.V286.Id.GoMatchPublicId))
...
type Msg
    = GameMsg GameMsg
    | SetupMsg SetupMsg
    | SelectedMatch (Maybe (Evergreen.V286.Id.Id Evergreen.V286.Id.ChannelMessageId))
    | PressedReset
    | PressedShareGoMatch (Evergreen.V286.Id.Id Evergreen.V286.Id.ChannelMessageId)
