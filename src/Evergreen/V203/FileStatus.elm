module Evergreen.V203.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V203.Coord.Coord Evergreen.V203.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V203.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V203.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V203.FileName.FileName Int ContentType Effect.Http.Error
