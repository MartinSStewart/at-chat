module Evergreen.V365.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V365.Id.Id Evergreen.V365.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V365.Id.Id Evergreen.V365.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V365.User.FrontendUser
    , joinedUser : Maybe Evergreen.V365.User.FrontendUser
    }
