module Evergreen.V365.FileStatus exposing (..)
...
type alias VideoMetadata =
    { videoSize : Evergreen.V365.Coord.Coord Evergreen.V365.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V365.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V365.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V365.FileName.FileName Int ContentType Effect.Http.Error
