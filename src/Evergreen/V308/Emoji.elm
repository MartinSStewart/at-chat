module Evergreen.V308.Emoji exposing (..)
...
type EmojiOrCustomEmoji
    ...
    | EmojiOrCustomEmoji_CustomEmoji (Evergreen.V308.Id.Id Evergreen.V308.Id.CustomEmojiId)
...
type EmojiOrSticker
    ...
    | EmojiOrSticker_Sticker (Evergreen.V308.Id.Id Evergreen.V308.Id.StickerId)
    | EmojiOrSticker_CustomEmoji (Evergreen.V308.Id.Id Evergreen.V308.Id.CustomEmojiId)
