module Evergreen.V308.WordSpellingGame exposing (..)
...
type GameMsg
    ...
    | PressedPlayerRow (Evergreen.V308.Id.Id Evergreen.V308.Id.UserId)
    | MouseEnterPlayerRow (Evergreen.V308.Id.Id Evergreen.V308.Id.UserId)
    | MouseExitPlayerRow (Evergreen.V308.Id.Id Evergreen.V308.Id.UserId)
    | UserScrolledPastMoves Evergreen.V308.Scroll.ScrollPosition
...
type SetupMsg
    ...
    | ChangedPlaceWordAttempts Evergreen.V308.OneOrGreater.OneOrGreater
    | PressedResetLetters
    | PressedStartGame
    | PressedCancel
...
type alias ValidatedSetup =
    { timeControls : Evergreen.V308.Go.TimeControl
    , traySize : Evergreen.V308.OneOrGreater.OneOrGreater
    , fullTrayBonus : Int
    ...
    , letters :
        Evergreen.V308.NonemptyDict.NonemptyDict
            LetterOrWildcard
            { count : Evergreen.V308.OneOrGreater.OneOrGreater
            , value : Int
            }
    , language : Language
    , placeWordAttempts : Evergreen.V308.OneOrGreater.OneOrGreater
    }
...
type Action
    = PlaceWord PlacedWord (Evergreen.V308.UserSession.ToBeFilledInByBackend IsValid)
    | ReplaceTrayOrPass
    | JoinGame
...
type alias Player =
    { userId : Evergreen.V308.Id.Id Evergreen.V308.Id.UserId
    , tray : Evergreen.V308.IdArray.IdArray LetterId LetterOrWildcard
    , score : Int
    }
...
type alias AnimatedPlacement =
    ...
    , isValid : Evergreen.V308.UserSession.ToBeFilledInByBackend IsValid
    }
...
type alias Shared =
    ...
    , attemptsLeft : Evergreen.V308.OneOrGreater.OneOrGreater
    }
...
type alias GameData =
    ...
    , showSettings : Bool
    , highlightedPlayer : Maybe (Evergreen.V308.Id.Id Evergreen.V308.Id.UserId)
    , scrollPosition : Evergreen.V308.Scroll.ScrollPosition
    }
