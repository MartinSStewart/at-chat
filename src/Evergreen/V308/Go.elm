module Evergreen.V308.Go exposing (..)
...
type Action
    ...
    | AcceptTerritory
    | RejectTerritory
    | Joined (Evergreen.V308.Id.Id Evergreen.V308.Id.UserId)
...
type alias Shared =
    ...
    , joinedUserId : Maybe (Evergreen.V308.Id.Id Evergreen.V308.Id.UserId)
    , turnCount : Int
    }
...
type alias PublicGoMatchData =
    ...
    , cache : Shared
    , creatorUser : Evergreen.V308.User.FrontendUser
    , joinedUser : Maybe Evergreen.V308.User.FrontendUser
    }
