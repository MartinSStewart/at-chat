module Evergreen.V308.FileStatus exposing (..)
...
type alias FileData =
    { fileName : Evergreen.V308.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V308.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V308.FileName.FileName Int ContentType Effect.Http.Error
