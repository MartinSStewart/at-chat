module Evergreen.V308.Drawing exposing (..)
...
type MessageAnchor
    = UserIconAnchor
    | TimestampAnchor
    | ImageAttachmentAnchor (Evergreen.V308.Id.Id Evergreen.V308.FileStatus.FileId)
    | EmbedImageAnchor Int
    | CardAnchor


type AnchorType
    = MessageAnchor Evergreen.V308.Id.ThreadRouteWithMessage MessageAnchor
    | DateDividerAnchor Evergreen.V308.Id.ThreadRoute Date.Date
