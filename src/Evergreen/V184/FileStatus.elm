module Evergreen.V184.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V184.Coord.Coord Evergreen.V184.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V184.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V184.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V184.FileName.FileName Int ContentType Effect.Http.Error
