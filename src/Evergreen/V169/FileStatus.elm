module Evergreen.V169.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V169.Coord.Coord Evergreen.V169.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V169.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V169.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V169.FileName.FileName Int ContentType Effect.Http.Error
