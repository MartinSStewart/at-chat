module Evergreen.V154.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V154.Coord.Coord Evergreen.V154.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V154.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V154.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V154.FileName.FileName Int ContentType Effect.Http.Error
