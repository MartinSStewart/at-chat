module Evergreen.V60.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V60.Id.Id Evergreen.V60.Id.UserId)
    ...
    | AttachedFile (Evergreen.V60.Id.Id Evergreen.V60.FileStatus.FileId)
