module Evergreen.V120.FileStatus exposing (..)
...
type alias ImageMetadata =
    { imageSize : Evergreen.V120.Coord.Coord Evergreen.V120.CssPixels.CssPixels
...
type alias FileData =
    { fileName : Evergreen.V120.FileName.FileName
    , fileSize : Int
...
type FileStatus
    = FileUploading
        Evergreen.V120.FileName.FileName
        { sent : Int
        , size : Int
        }
        ContentType
    | FileUploaded FileData
    | FileError Evergreen.V120.FileName.FileName Int ContentType Effect.Http.Error
