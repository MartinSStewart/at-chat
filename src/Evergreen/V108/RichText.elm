module Evergreen.V108.RichText exposing (..)
...
type RichText
    = UserMention (Evergreen.V108.Id.Id Evergreen.V108.Id.UserId)
    ...
    | AttachedFile (Evergreen.V108.Id.Id Evergreen.V108.FileStatus.FileId)
