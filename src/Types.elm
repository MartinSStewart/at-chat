...
type LocalChange
    ...
    | Local_SendMessage Time.Posix GuildOrDmId (Nonempty (RichText (Id UserId))) ThreadRouteWithMaybeMessage (Untrusted (SeqDict (Id FileId) FileData))
    | Local_Discord_SendMessage Time.Posix DiscordGuildOrDmId (Nonempty (RichText (Discord.Id Discord.UserId))) ThreadRouteWithMaybeMessage (Untrusted (Untrusted (SeqDict (Id FileId) FileData)))
    ...
    | Local_SendEditMessage Time.Posix GuildOrDmId ThreadRouteWithMessage (Nonempty (RichText (Id UserId))) (Untrusted (SeqDict (Id FileId) FileData))
