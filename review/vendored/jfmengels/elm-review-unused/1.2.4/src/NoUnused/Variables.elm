...
import NoUnused.Vendor.ListExtra as ListExtra
...
finalEvaluation context =
    let
        ...
        usedModules : Set ( ModuleName, ModuleName )
        usedModules =
            ListExtra.insertAllJusts moduleThatExposeEverythingErrors context.usedModules

        addModuleErrors : List (Error {}) -> List (Error {})
        addModuleErrors acc =
            ListExtra.listFilterThenMapInto
                (\variableInfo ->
                    let
        ...
        addCustomTypeErrors acc =
            if context.exposesEverything then
                ...
                ListExtra.dictToListFilterAndMap
